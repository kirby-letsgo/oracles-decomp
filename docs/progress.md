...
- Milestone 3 (readable C engine) started 2026-09-09: plan in
  ...
  routine against the transliteration. Progress: 1,492 routines rewritten across fifteen code banks;
  ...
  room-visited, warp-site/tree helpers, and the bank-1 toggle-block cutscene state machine.
