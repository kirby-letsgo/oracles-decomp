...
- Milestone 3 (readable C engine) started 2026-09-09: plan in
  ...
  routine against the transliteration. Progress: 1,542 routines rewritten across fifteen code banks;
  ...
  selector, and a late miscellaneous-cutscene graphics/effects cluster.
