...
- Milestone 3 (readable C engine) started 2026-09-09: plan in
  ...
  routine against the transliteration. Progress: 1,560 routines rewritten across fifteen code banks;
  ...
  remaining safe palette-thread handlers and the full fading/color-mixing loops.
