...
void bear_state1_hook(GB *gb) {
  uint16_t sp0_ = gb->sp; (void)sp0_;
  CYC(0x6dcb, 0x6dcd); E = 0x42;
  CYC(0x6dcd, 0x6dce); A = mem_rd(gb, DE);
  CYC(0x6dce, 0x6dcf); push_effect(gb, 0x6dcf); SET_HL(bank09_jump_table(gb));
  switch (HL) { case 0x6dd5: goto L_6dd5; case 0x261b: interactionAnimate_hook(gb); return; case 0x6e4c: goto L_6e4c; default: HANDOFF(HL); }
L_6dd5:
