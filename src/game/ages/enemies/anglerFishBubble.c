...
popAnimation:
  ...
  CYC(b_+125, b_+128); TAIL(objectSetVisible83); // jp
}
...
haveOffset:
  ...
  CYC(b_+50, b_+53); TAIL(objectSetVisible81); // jp
...
animate:
  CYC(b_+76, b_+79); TAIL(enemyAnimate); // jp
...
state2:
  ...
  CYC(b_+131, b_+133);
  CYC(b_+133, b_+136); TAIL(enemyDelete); // jp
}
