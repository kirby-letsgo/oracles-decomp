...
void enemyCode02_hook(GB *gb) {
  ...
  CYC(b_+15, b_+18); if (hook_is(gb, SYM(ecom_updateKnockback_b10), ecom_updateKnockback_b10_hook)) { ecom_updateKnockback_b10_hook(gb); return; } HANDOFF(SYM(ecom_updateKnockback_b10));  // jp ecom_updateKnockback
justHit:
...
normalStatus:
  ...
  do { uint16_t jt_ = (veranFinal_jump_table(gb));
    if (jt_ == SYM(veranFinal_turtleForm) && hook_is(gb, SYM(veranFinal_turtleForm), veranFinal_turtleForm_hook)) { veranFinal_turtleForm_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm) && hook_is(gb, SYM(veranFinal_spiderForm), veranFinal_spiderForm_hook)) { veranFinal_spiderForm_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm) && hook_is(gb, SYM(veranFinal_beeForm), veranFinal_beeForm_hook)) { veranFinal_beeForm_hook(gb); return; }
...
void veranFinal_turtleForm_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (veranFinal_jump_table(gb));
    if (jt_ == SYM(veranFinal_turtleForm_state0) && hook_is(gb, SYM(veranFinal_turtleForm_state0), veranFinal_turtleForm_state0_hook)) { veranFinal_turtleForm_state0_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_state1) && hook_is(gb, SYM(veranFinal_turtleForm_state1), veranFinal_turtleForm_state1_hook)) { veranFinal_turtleForm_state1_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_state2) && hook_is(gb, SYM(veranFinal_turtleForm_state2), veranFinal_turtleForm_state2_hook)) { veranFinal_turtleForm_state2_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_state3) && hook_is(gb, SYM(veranFinal_turtleForm_state3), veranFinal_turtleForm_state3_hook)) { veranFinal_turtleForm_state3_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_state4) && hook_is(gb, SYM(veranFinal_turtleForm_state4), veranFinal_turtleForm_state4_hook)) { veranFinal_turtleForm_state4_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_state5) && hook_is(gb, SYM(veranFinal_turtleForm_state5), veranFinal_turtleForm_state5_hook)) { veranFinal_turtleForm_state5_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_state6) && hook_is(gb, SYM(veranFinal_turtleForm_state6), veranFinal_turtleForm_state6_hook)) { veranFinal_turtleForm_state6_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_state7) && hook_is(gb, SYM(veranFinal_turtleForm_state7), veranFinal_turtleForm_state7_hook)) { veranFinal_turtleForm_state7_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_state8) && hook_is(gb, SYM(veranFinal_turtleForm_state8), veranFinal_turtleForm_state8_hook)) { veranFinal_turtleForm_state8_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_state9) && hook_is(gb, SYM(veranFinal_turtleForm_state9), veranFinal_turtleForm_state9_hook)) { veranFinal_turtleForm_state9_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_turtleForm_stateA) && hook_is(gb, SYM(veranFinal_turtleForm_stateA), veranFinal_turtleForm_stateA_hook)) { veranFinal_turtleForm_stateA_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
setForms:
  ...
  CYC(b_+56, b_+59); if (hook_is(gb, SYM(objectSetVisible83), objectSetVisible83_hook)) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
substate0:
  ...
  CYC(b_+25, b_+28); if (hook_is(gb, SYM(ecom_incSubstate_b10), ecom_incSubstate_b10_hook)) { ecom_incSubstate_b10_hook(gb); return; } HANDOFF(SYM(ecom_incSubstate_b10));  // jp ecom_incSubstate
substate1:
  ...
  CYC(b_+48, b_+51); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
substate2:
  ...
  CYC(b_+71, b_+74); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void veranFinal_turtleForm_state3_hook(GB *gb) {
  ...
  if (!(F & FZ)) { CYCT(b_+7, b_+10); if (hook_is(gb, SYM(ecom_applyVelocityForTopDownEnemyNoHoles_b10), ecom_applyVelocityForTopDownEnemyNoHoles_b10_hook)) { ecom_applyVelocityForTopDownEnemyNoHoles_b10_hook(gb); return; } HANDOFF(SYM(ecom_applyVelocityForTopDownEnemyNoHoles_b10)); } CYC(b_+7, b_+10);  // jp nz,ecom_applyVelocityForTopDownEnemyNoHoles
...
nextState:
  ...
  CYC(b_+40, b_+43); if (hook_is(gb, SYM(ecom_spawnProjectile_b10), ecom_spawnProjectile_b10_hook)) { ecom_spawnProjectile_b10_hook(gb); return; } HANDOFF(SYM(ecom_spawnProjectile_b10));  // jp ecom_spawnProjectile
}
...
tryOpenFace:
  ...
  CYC(b_+62, b_+65); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
jumpAgain:
...
nextState:
  ...
  CYC(b_+26, b_+29); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
nextState:
  ...
  CYC(b_+28, b_+31); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
showText:
  CYC(b_+48, b_+51); if (hook_is(gb, SYM(showText), showText_hook)) { showText_hook(gb); return; } HANDOFF(SYM(showText));  // jp showText
substate1:
  ...
  CYC(b_+71, b_+74); if (hook_is(gb, SYM(createEnergySwirlGoingOut), createEnergySwirlGoingOut_hook)) { createEnergySwirlGoingOut_hook(gb); return; } HANDOFF(SYM(createEnergySwirlGoingOut));  // jp createEnergySwirlGoingOut
substate2:
  ...
  CYC(b_+85, b_+88); if (hook_is(gb, SYM(ecom_incSubstate_b10), ecom_incSubstate_b10_hook)) { ecom_incSubstate_b10_hook(gb); return; } HANDOFF(SYM(ecom_incSubstate_b10));  // jp ecom_incSubstate
substate3:
  ...
  CYC(b_+106, b_+109); if (hook_is(gb, SYM(enemyDelete), enemyDelete_hook)) { enemyDelete_hook(gb); return; } HANDOFF(SYM(enemyDelete));  // jp enemyDelete
}
...
void veranFinal_spiderForm_hook(GB *gb) {
  ...
  CYC(b_+1, b_+2); push_effect(gb, b_+2);
  do { uint16_t jt_ = (veranFinal_jump_table(gb));
    if (jt_ == SYM(veranFinal_spiderOrBeeForm_state0) && hook_is(gb, SYM(veranFinal_spiderOrBeeForm_state0), veranFinal_spiderOrBeeForm_state0_hook)) { veranFinal_spiderOrBeeForm_state0_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_state1) && hook_is(gb, SYM(veranFinal_spiderForm_state1), veranFinal_spiderForm_state1_hook)) { veranFinal_spiderForm_state1_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_state2) && hook_is(gb, SYM(veranFinal_spiderForm_state2), veranFinal_spiderForm_state2_hook)) { veranFinal_spiderForm_state2_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_state3) && hook_is(gb, SYM(veranFinal_spiderForm_state3), veranFinal_spiderForm_state3_hook)) { veranFinal_spiderForm_state3_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_state4) && hook_is(gb, SYM(veranFinal_spiderForm_state4), veranFinal_spiderForm_state4_hook)) { veranFinal_spiderForm_state4_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
void veranFinal_spiderForm_state3_hook(GB *gb) {
  ...
  if ((F & FC)) { CYCT(b_+6, b_+9); if (hook_is(gb, SYM(objectUpdateSpeedZ_paramC), objectUpdateSpeedZ_paramC_hook)) { objectUpdateSpeedZ_paramC_hook(gb); return; } HANDOFF(SYM(objectUpdateSpeedZ_paramC)); } CYC(b_+6, b_+9);  // jp c,objectUpdateSpeedZ_paramC
...
void veranFinal_spiderForm_state4_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (veranFinal_jump_table(gb));
    if (jt_ == SYM(veranFinal_spiderForm_rushAttack) && hook_is(gb, SYM(veranFinal_spiderForm_rushAttack), veranFinal_spiderForm_rushAttack_hook)) { veranFinal_spiderForm_rushAttack_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_jumpAttack) && hook_is(gb, SYM(veranFinal_spiderForm_jumpAttack), veranFinal_spiderForm_jumpAttack_hook)) { veranFinal_spiderForm_jumpAttack_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_webAttack) && hook_is(gb, SYM(veranFinal_spiderForm_webAttack), veranFinal_spiderForm_webAttack_hook)) { veranFinal_spiderForm_webAttack_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
substate1:
  ...
  CYC(b_+12, b_+15); if (hook_is(gb, SYM(enemyAnimate), enemyAnimate_hook)) { enemyAnimate_hook(gb); return; } HANDOFF(SYM(enemyAnimate));  // jp enemyAnimate
substate0:
...
substate0:
  ...
  CYC(b_+28, b_+31); if (hook_is(gb, SYM(objectSetVisible81), objectSetVisible81_hook)) { objectSetVisible81_hook(gb); return; } HANDOFF(SYM(objectSetVisible81));  // jp objectSetVisible81
substate1:
...
zh:
  ...
  CYC(b_+75, b_+78); if (hook_is(gb, SYM(objectSetInvisible), objectSetInvisible_hook)) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
substate2:
  ...
  CYC(b_+111, b_+114); if (hook_is(gb, SYM(objectSetVisible81), objectSetVisible81_hook)) { objectSetVisible81_hook(gb); return; } HANDOFF(SYM(objectSetVisible81));  // jp objectSetVisible81
substate3:
  ...
  CYC(b_+136, b_+139); if (hook_is(gb, SYM(objectSetVisible83), objectSetVisible83_hook)) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
substate4:
...
void veranFinal_spiderForm_webAttack_hook(GB *gb) {
  ...
  CYC(b_+1, b_+2); push_effect(gb, b_+2);
  do { uint16_t jt_ = (veranFinal_jump_table(gb));
    if (jt_ == SYM(veranFinal_spiderForm_webAttack_substate0) && hook_is(gb, SYM(veranFinal_spiderForm_webAttack_substate0), veranFinal_spiderForm_webAttack_substate0_hook)) { veranFinal_spiderForm_webAttack_substate0_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_webAttack_substate1) && hook_is(gb, SYM(veranFinal_spiderForm_webAttack_substate1), veranFinal_spiderForm_webAttack_substate1_hook)) { veranFinal_spiderForm_webAttack_substate1_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_webAttack_substate2) && hook_is(gb, SYM(veranFinal_spiderForm_webAttack_substate2), veranFinal_spiderForm_webAttack_substate2_hook)) { veranFinal_spiderForm_webAttack_substate2_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_webAttack_substate3) && hook_is(gb, SYM(veranFinal_spiderForm_webAttack_substate3), veranFinal_spiderForm_webAttack_substate3_hook)) { veranFinal_spiderForm_webAttack_substate3_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_webAttack_substate4) && hook_is(gb, SYM(veranFinal_spiderForm_webAttack_substate4), veranFinal_spiderForm_webAttack_substate4_hook)) { veranFinal_spiderForm_webAttack_substate4_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_webAttack_substate5) && hook_is(gb, SYM(veranFinal_spiderForm_webAttack_substate5), veranFinal_spiderForm_webAttack_substate5_hook)) { veranFinal_spiderForm_webAttack_substate5_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_webAttack_substate6) && hook_is(gb, SYM(veranFinal_spiderForm_webAttack_substate6), veranFinal_spiderForm_webAttack_substate6_hook)) { veranFinal_spiderForm_webAttack_substate6_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_spiderForm_webAttack_substate7) && hook_is(gb, SYM(veranFinal_spiderForm_webAttack_substate7), veranFinal_spiderForm_webAttack_substate7_hook)) { veranFinal_spiderForm_webAttack_substate7_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
void veranFinal_spiderForm_webAttack_updateLinkPosition_hook(GB *gb) {
  ...
  CYC(b_+5, b_+8); if (hook_is(gb, SYM(objectCopyPositionWithOffset), objectCopyPositionWithOffset_hook)) { objectCopyPositionWithOffset_hook(gb); return; } HANDOFF(SYM(objectCopyPositionWithOffset));  // jp objectCopyPositionWithOffset
}
...
void veranFinal_spiderForm_webAttack_applyDamageToLink_hook(GB *gb) {
  ...
  CYC(b_+8, b_+11); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
...
void veranFinal_beeForm_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (veranFinal_jump_table(gb));
    if (jt_ == SYM(veranFinal_spiderOrBeeForm_state0) && hook_is(gb, SYM(veranFinal_spiderOrBeeForm_state0), veranFinal_spiderOrBeeForm_state0_hook)) { veranFinal_spiderOrBeeForm_state0_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_state1) && hook_is(gb, SYM(veranFinal_beeForm_state1), veranFinal_beeForm_state1_hook)) { veranFinal_beeForm_state1_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_state2) && hook_is(gb, SYM(veranFinal_beeForm_state2), veranFinal_beeForm_state2_hook)) { veranFinal_beeForm_state2_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_state3) && hook_is(gb, SYM(veranFinal_beeForm_state3), veranFinal_beeForm_state3_hook)) { veranFinal_beeForm_state3_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_state4) && hook_is(gb, SYM(veranFinal_beeForm_state4), veranFinal_beeForm_state4_hook)) { veranFinal_beeForm_state4_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_state5) && hook_is(gb, SYM(veranFinal_beeForm_state5), veranFinal_beeForm_state5_hook)) { veranFinal_beeForm_state5_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_state6) && hook_is(gb, SYM(veranFinal_beeForm_state6), veranFinal_beeForm_state6_hook)) { veranFinal_beeForm_state6_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_state7) && hook_is(gb, SYM(veranFinal_beeForm_state7), veranFinal_beeForm_state7_hook)) { veranFinal_beeForm_state7_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_state8) && hook_is(gb, SYM(veranFinal_beeForm_state8), veranFinal_beeForm_state8_hook)) { veranFinal_beeForm_state8_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_state9) && hook_is(gb, SYM(veranFinal_beeForm_state9), veranFinal_beeForm_state9_hook)) { veranFinal_beeForm_state9_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_stateA) && hook_is(gb, SYM(veranFinal_beeForm_stateA), veranFinal_beeForm_stateA_hook)) { veranFinal_beeForm_stateA_hook(gb); return; }
    else if (jt_ == SYM(veranFinal_beeForm_stateB) && hook_is(gb, SYM(veranFinal_beeForm_stateB), veranFinal_beeForm_stateB_hook)) { veranFinal_beeForm_stateB_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
applySpeed:
  ...
  CYC(b_+35, b_+38); if (hook_is(gb, SYM(objectSetInvisible), objectSetInvisible_hook)) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
haveAngle:
  ...
  CYC(b_+36, b_+39); if (hook_is(gb, SYM(objectSetVisible83), objectSetVisible83_hook)) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
applySpeed:
  ...
  if (!(F & FC)) { CYCT(b_+25, b_+28); if (hook_is(gb, SYM(enemyAnimate), enemyAnimate_hook)) { enemyAnimate_hook(gb); return; } HANDOFF(SYM(enemyAnimate)); } CYC(b_+25, b_+28);  // jp nc,enemyAnimate
  CALL_C(b_+28, ecom_incState_b10_hook, SYM(ecom_incState_b10), b_+31);
  CYC(b_+31, b_+33); L = 0x86;  // ld l,Enemy.counter1
  ...
  CYC(b_+39, b_+42); if (hook_is(gb, SYM(objectSetInvisible), objectSetInvisible_hook)) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
haveSubid:
  ...
  CYC(b_+57, b_+60); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
...
transformed:
  ...
  CYC(b_+62, b_+65); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
