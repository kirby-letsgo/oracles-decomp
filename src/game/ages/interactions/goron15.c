...
void goron_cpLinkY_hook(GB *gb) {
  ...
  CYC(b_+5, b_+7); goron_cpLinkY_writeResult(gb);
}
...
void goron_checkReachedLinkHorizontally_hook(GB *gb) {
  ...
  CYC(b_+6, b_+8); goron_checkReachedLinkHorizontally_writeResult(gb);
}
...
L_nextTile:
  ...
  CYC(b_+28, b_+30); A = mem_rd(gb, hFF8B);
...
static void goron_createRockDebris_body(GB *gb, uint16_t sp0_) {
  ...
  CYC(b_+8, b_+10); mem_wr(gb, hFF8D, A);
  CYC(b_+10, b_+11); alu_xor(gb, A);
L_nextRock:
  CYC(b_+11, b_+13); mem_wr(gb, hFF8B, A);
  ...
  CYC(b_+28, b_+30); A = mem_rd(gb, hFF8D);
  CYC(b_+30, b_+31); mem_wr(gb, HL, A);
  CYC(b_+31, b_+33); L = 0x49;
  CYC(b_+33, b_+35); A = mem_rd(gb, hFF8B);
  ...
  CYC(b_+48, b_+51); playSound_b00_hook(gb);
}
...
void goron_createRockDebrisToLeft_hook(GB *gb) {
  ...
  CYC(b_+3, b_+5); goron_createRockDebris_body(gb, sp0_);
}
