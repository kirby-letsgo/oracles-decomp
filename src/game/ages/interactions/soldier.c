...
void soldierSubid00_hook(GB *gb) {
  ...
  CYC(b_+19, b_+22);
  CYC(b_+22, b_+24); TAIL(soldierSubid0c);
}
...
void soldierSubid04Substate1_hook(GB *gb) {
  ...
  CYC(b_+18, b_+21); TAIL(playSound_b00);
}
...
void soldierSubid04Substate3_hook(GB *gb) {
  ...
  CYC(b_+12, b_+15); TAIL(interactionIncSubstate);
}
...
void soldierSubid04Substate4_hook(GB *gb) {
  ...
  CYC(b_+9, b_+12); TAIL(interactionAnimateBasedOnSpeed);
}
...
L_50b0:
  ...
  CYC(b_+57, b_+60); TAIL(interactionAnimate2Times);
}
...
update:
  CYC(b_+52, b_+55); TAIL(soldierUpdateAnimationAndRunScript);
}
...
state1:
  ...
  CYC(b_+20, b_+23); TAIL(interactionAnimateAsNpc);
}
...
state1:
  ...
  CYC(b_+23, b_+26); TAIL(interactionAnimate);
}
...
state1:
  ...
  CYC(b_+30, b_+33); TAIL(setWarpDestVariables);
}
...
L_51bc:
  ...
  CYC(b_+90, b_+93); TAIL(interactionPushLinkAwayAndUpdateDrawPriority);
}
...
void label_09_092_hook(GB *gb) {
  ...
  CYC(b_+3, b_+6);
  CYC(b_+6, b_+9); TAIL(npcFaceLinkAndAnimate);
}
...
void label_09_094_hook(GB *gb) {
  BASE(label_09_094);
  uint16_t sp0_ = gb->sp; (void)sp0_;
  CYC(b_+0, b_+3); TAIL(objectPreventLinkFromPassing);
}
...
void label_09_095_hook(GB *gb) {
  ...
  uint16_t sp0_ = gb->sp; (void)sp0_;
  CALL_C(b_+0, interactionRunScript_hook, SYM(interactionRunScript), b_+3);
  CYC(b_+3, b_+6); TAIL(interactionAnimate);
}
