...
void updateItemPost_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (item_post_jump_table(gb));
    if (jt_ == SYM(itemCodeNilPost) && hook_is(gb, SYM(itemCodeNilPost), itemCodeNilPost_hook)) { itemCodeNilPost_hook(gb); return; }
    else if (jt_ == SYM(itemCode00Post) && hook_is(gb, SYM(itemCode00Post), itemCode00Post_hook)) { itemCode00Post_hook(gb); return; }
    else if (jt_ == SYM(itemCode04Post) && hook_is(gb, SYM(itemCode04Post), itemCode04Post_hook)) { itemCode04Post_hook(gb); return; }
    else if (jt_ == SYM(itemCode08Post) && hook_is(gb, SYM(itemCode08Post), itemCode08Post_hook)) { itemCode08Post_hook(gb); return; }
    else if (jt_ == SYM(itemCode0aPost) && hook_is(gb, SYM(itemCode0aPost), itemCode0aPost_hook)) { itemCode0aPost_hook(gb); return; }
    else if (jt_ == SYM(itemCode0bPost) && hook_is(gb, SYM(itemCode0bPost), itemCode0bPost_hook)) { itemCode0bPost_hook(gb); return; }
    else if (jt_ == SYM(itemCode0cPost) && hook_is(gb, SYM(itemCode0cPost), itemCode0cPost_hook)) { itemCode0cPost_hook(gb); return; }
    else if (jt_ == SYM(itemCode0fPost) && hook_is(gb, SYM(itemCode0fPost), itemCode0fPost_hook)) { itemCode0fPost_hook(gb); return; }
    else if (jt_ == SYM(itemCode13Post) && hook_is(gb, SYM(itemCode13Post), itemCode13Post_hook)) { itemCode13Post_hook(gb); return; }
    else if (jt_ == SYM(itemCode1dPost) && hook_is(gb, SYM(itemCode1dPost), itemCode1dPost_hook)) { itemCode1dPost_hook(gb); return; }
    else if (jt_ == SYM(itemCode1ePost) && hook_is(gb, SYM(itemCode1ePost), itemCode1ePost_hook)) { itemCode1ePost_hook(gb); return; }
    else if (jt_ == SYM(itemDelete) && hook_is(gb, SYM(itemDelete), itemDelete_hook)) { itemDelete_hook(gb); return; }
    else { HANDOFF(jt_); }
  } while (0);
}
