...
static void ghost_veran_rumble_and_randomize_x(GB *gb, uint16_t sp0_) {
  CYC(0x4dcb, 0x4dce); A = mem_rd(gb, wFrameCounter);
...
void interactionCode3e_hook(GB *gb) {
  ...
  CYC(0x4cb1, 0x4cb2); push_effect(gb, 0x4cb2);
  switch (ghost_veran_jump_table(gb)) {
    case 0x4cb6:
      CYC(0x4cb6, 0x4cb8); A = 1;
      ...
      CYC(0x4cc2, 0x4cc3); push_effect(gb, 0x4cc3);
      switch (ghost_veran_jump_table(gb)) {
        case 0x4cc9:
          CYC(0x4cc9, 0x4ccb); E = 0x46;
          CYC(0x4ccb, 0x4ccd); A = 0x78;
          CYC(0x4ccd, 0x4cce); mem_wr(gb, DE, A);
          CYC(0x4cce, 0x4cd1); interactionSetAlwaysUpdateBit_hook(gb); return;
        case 0x4cd1:
...
void runVeranGhostSubid0_hook(GB *gb) {
  ...
  CYC(0x4d04, 0x4d05); push_effect(gb, 0x4d05);
  switch (ghost_veran_jump_table(gb)) {
    case 0x4d17:
      CALL_C(0x4d17, interactionDecCounter1_hook, 0x23cc, 0x4d1a);
      if (!(F & FZ)) { CYCT(0x4d1a, 0x4d1c); goto substate0_visible; }
      CYC(0x4d1a, 0x4d1c);
      CYC(0x4d1c, 0x4d1e); mem_wr(gb, HL, 0x5a);
      CYC(0x4d1e, 0x4d20); L = 0x49;
      CYC(0x4d20, 0x4d22); mem_wr(gb, HL, 0);
      ...
      CYC(0x4d2e, 0x4d31); objectSetVisible80_hook(gb); return;
substate0_visible:
      CYC(0x4d31, 0x4d34); A = mem_rd(gb, wFrameCounter);
      CYC(0x4d34, 0x4d35); alu_rrca(gb);
      if (!(F & FC)) { CYCT(0x4d35, 0x4d38); objectSetVisible83_hook(gb); return; }
      CYC(0x4d35, 0x4d38);
      CYC(0x4d38, 0x4d3b); objectSetVisible80_hook(gb); return;
    case 0x4d3b:
      CALL_C(0x4d3b, interactionDecCounter1_hook, 0x23cc, 0x4d3e);
      if (!(F & FZ)) { CYCT(0x4d3e, 0x4d41); objectApplySpeed_hook(gb); return; }
      CYC(0x4d3e, 0x4d41);
      CALL_C(0x4d41, interactionIncSubstate_hook, 0x23e5, 0x4d44);
      CYC(0x4d44, 0x4d47); SET_HL(0x5db1);
      CYC(0x4d47, 0x4d4a); interactionSetScript_hook(gb); return;
    case 0x4d4a:
      CYC(0x4d4a, 0x4d4d); A = mem_rd(gb, 0xcfd1);
      CYC(0x4d4d, 0x4d4e); alu_or(gb, A);
      if (F & FZ) { CYCT(0x4d4e, 0x4d50); goto script_position; }
      CYC(0x4d4e, 0x4d50);
      CYC(0x4d50, 0x4d53); SET_BC(0xbb00);
      CALL_C(0x4d53, objectCreateInteraction_hook, 0x24c5, 0x4d56);
      if (!(F & FZ)) { CYCT(0x4d56, 0x4d57); ret_effect(gb); return; }
      CYC(0x4d56, 0x4d57);
      ...
      CYC(0x4d6d, 0x4d70); playSound_b00_hook(gb); return;
script_position:
      ghost_veran_update_script_position(gb, sp0_, 0x4d70, 0x4d73);
      CYC(0x4d7d, 0x4d80); interactionRunScript_hook(gb); return;
    case 0x4d80:
      CYC(0x4d80, 0x4d81); H = D;
      CYC(0x4d81, 0x4d83); L = 0x78;
      CYC(0x4d83, 0x4d84); mem_wr(gb, HL, alu_dec8(gb, mem_rd(gb, HL)));
      CYC(0x4d84, 0x4d86); B = 1;
      if (!(F & FZ)) { CYCT(0x4d86, 0x4d89); objectFlickerVisibility_hook(gb); return; }
      CYC(0x4d86, 0x4d89);
      ...
      CYC(0x4d90, 0x4d92); alu_cp(gb, 4);
      if (!(F & FZ)) { CYCT(0x4d92, 0x4d95); objectSetVisible_hook(gb); return; }
      CYC(0x4d92, 0x4d95);
      CALL_C(0x4d95, objectSetInvisible_hook, 0x1e7b, 0x4d98);
      CYC(0x4d98, 0x4d9a); A = 0xab;
      CYC(0x4d9a, 0x4d9d); playSound_b00_hook(gb); return;
    case 0x4d9d:
      CYC(0x4d9d, 0x4da0); A = mem_rd(gb, 0xcfd1);
      CYC(0x4da0, 0x4da2); alu_cp(gb, 2);
      if (!(F & FZ)) { CYCT(0x4da2, 0x4da3); ret_effect(gb); return; }
      CYC(0x4da2, 0x4da3);
      CYC(0x4da3, 0x4da5);
      CALL_C(0x4d5d, interactionIncSubstate_hook, 0x23e5, 0x4d60);
      CYC(0x4d60, 0x4d62); L = 0x78;
    ...
    case 0x4da5:
      ...
      if (!(F & FZ)) { CYCT(0x4daa, 0x4dac); goto script_position_2; }
      CYC(0x4daa, 0x4dac);
      CYC(0x4dac, 0x4daf); SET_BC(0x0302);
      CYC(0x4daf, 0x4db2); push_effect(gb, 0x4db2);
      ghost_veran_rumble_and_randomize_x(gb, sp0_);
      CYC(0x4db2, 0x4db4); goto run_script;
script_position_2:
      ghost_veran_update_script_position(gb, sp0_, 0x4db4, 0x4db7);
run_script:
      CALL_C(0x4dc1, interactionRunScript_hook, 0x2552, 0x4dc4);
      if (!(F & FC)) { CYCT(0x4dc4, 0x4dc5); ret_effect(gb); return; }
      CYC(0x4dc4, 0x4dc5);
      CALL_C(0x4dc5, objectSetInvisible_hook, 0x1e7b, 0x4dc8);
      CYC(0x4dc8, 0x4dcb); interactionIncSubstate_hook(gb); return;
    case 0x4de2:
    ...
    case 0x4df4:
      ...
      if (!(F & FC)) { CYCT(0x4df7, 0x4df8); ret_effect(gb); return; }
      CYC(0x4df7, 0x4df8);
      CYC(0x4df8, 0x4dfb); interactionDelete_hook(gb); return;
    default: HANDOFF(HL);
  }
}
...
void runVeranGhostSubid1_hook(GB *gb) {
  uint16_t sp0_ = gb->sp;
  CYC(0x4dfb, 0x4dfe); A = mem_rd(gb, wTextIsActive);
  CYC(0x4dfe, 0x4dff); alu_or(gb, A);
  if (F & FZ) {
    CYC(0x4dff, 0x4e01);
    CALL_C(0x4e01, interactionRunScript_hook, 0x2552, 0x4e04);
    if (F & FC) { CYCT(0x4e04, 0x4e07); interactionDelete_hook(gb); return; }
    CYC(0x4e04, 0x4e07);
  } else CYCT(0x4dff, 0x4e01);
  CYC(0x4e07, 0x4e0a); interactionAnimate_hook(gb);
}
...
void runVeranGhostSubid2_hook(GB *gb) {
  ...
  switch (ghost_veran_jump_table(gb)) {
    case 0x4e16:
      ...
      CYC(0x4e3e, 0x4e40); goto animate;
move:
...
animate:
      CYC(0x4e49, 0x4e4c); interactionAnimate_hook(gb); return;
    case 0x4e4c:
      CALL_C(0x4e4c, interactionDecCounter1_hook, 0x23cc, 0x4e4f);
      if (!(F & FZ)) { CYCT(0x4e4f, 0x4e51); CYC(0x4e49, 0x4e4c); interactionAnimate_hook(gb); return; }
      CYC(0x4e4f, 0x4e51);
      CYC(0x4e51, 0x4e52); L = E;
      CYC(0x4e52, 0x4e53); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));
      CYC(0x4e53, 0x4e56); SET_BC(0x560e);
      CYC(0x4e56, 0x4e59); showText_hook(gb); return;
    case 0x4e59:
      CALL_C(0x4e59, getFreeEnemySlot_hook, 0x2e27, 0x4e5c);
      if (!(F & FZ)) { CYCT(0x4e5c, 0x4e5d); ret_effect(gb); return; }
      CYC(0x4e5c, 0x4e5d);
      CYC(0x4e5d, 0x4e5f); mem_wr(gb, HL, 6);
    ...
    case 0x4e72:
      ...
      if (F & FZ) { CYCT(0x4e75, 0x4e77); goto delete; }
      CYC(0x4e75, 0x4e77);
      ...
      if (F & FZ) { CYCT(0x4e7e, 0x4e81); objectSetVisible82_hook(gb); return; }
      CYC(0x4e7e, 0x4e81);
      CYC(0x4e81, 0x4e84); objectSetInvisible_hook(gb); return;
delete:
      CYC(0x4e84, 0x4e86); A = 1;
      CYC(0x4e86, 0x4e89); W8(wLoadedTreeGfxIndex) = A;
      CYC(0x4e89, 0x4e8c); interactionDelete_hook(gb); return;
    default: HANDOFF(HL);
  }
}
