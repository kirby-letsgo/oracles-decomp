...
#undef CYC
#undef CYCT
#define CYC(from, to) burn_rom(gb, SYMBANK(partCode52), (from), (to), false)
#define CYCT(from, to) burn_rom(gb, SYMBANK(partCode52), (from), (to), true)
...
subid2_state2:
  ...
  CYC(b_+294, SYM(partCode53)); partSetAnimation_hook(gb); return; // jp
}
