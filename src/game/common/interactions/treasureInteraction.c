...
L_49a1:
  ...
  CYC(b_+51,b_+54); if (hook_is(gb, SYM(objectSetVisiblec2), objectSetVisiblec2_hook)) { objectSetVisiblec2_hook(gb); return; } HANDOFF(SYM(objectSetVisiblec2));
L_49a9:
...
L_49bb:
  ...
  CYC(b_+86,b_+89); if (hook_is(gb, SYM(objectSetVisiblec2), objectSetVisiblec2_hook)) { objectSetVisiblec2_hook(gb); return; } HANDOFF(SYM(objectSetVisiblec2));
L_49cc:
...
L_49ee:
  ...
  CYC(b_+133,b_+136); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));
L_49fb:
...
L_4a14:
  ...
  CYC(b_+183,b_+186); if (hook_is(gb, SYM(objectReplaceWithFallingDownHoleInteraction), objectReplaceWithFallingDownHoleInteraction_hook)) { objectReplaceWithFallingDownHoleInteraction_hook(gb); return; } HANDOFF(SYM(objectReplaceWithFallingDownHoleInteraction));
L_4a2d:
  ...
  CYC(b_+199,b_+202); if (hook_is(gb, SYM(objectSetSpeedZ), objectSetSpeedZ_hook)) { objectSetSpeedZ_hook(gb); return; } HANDOFF(SYM(objectSetSpeedZ));
L_4a3d:
...
L_4a47:
  ...
  if (!(F & FC)) { CYCT(b_+215,b_+218); if (hook_is(gb, SYM(objectSetInvisible), objectSetInvisible_hook)) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible)); } CYC(b_+215,b_+218);
  CYC(b_+218,b_+221); if (hook_is(gb, SYM(objectSetVisible), objectSetVisible_hook)) { objectSetVisible_hook(gb); return; } HANDOFF(SYM(objectSetVisible));
L_4a50:
...
L_4a55:
  ...
  CYC(b_+236,b_+239); if (hook_is(gb, SYM(interactionSetAlwaysUpdateBit), interactionSetAlwaysUpdateBit_hook)) { interactionSetAlwaysUpdateBit_hook(gb); return; } HANDOFF(SYM(interactionSetAlwaysUpdateBit));
L_4a62:
  ...
  CYC(b_+257,b_+260); if (hook_is(gb, SYM(objectCreateInteractionWithSubid00), objectCreateInteractionWithSubid00_hook)) { objectCreateInteractionWithSubid00_hook(gb); return; } HANDOFF(SYM(objectCreateInteractionWithSubid00));
L_4a77:
...
L_4a86:
  ...
  CYC(b_+292,b_+295); if (hook_is(gb, SYM(objectSetVisible80), objectSetVisible80_hook)) { objectSetVisible80_hook(gb); return; } HANDOFF(SYM(objectSetVisible80));
L_4a9a:
...
L_4ab0:
  ...
  CYC(b_+333,b_+336); if (hook_is(gb, SYM(interactionDelete), interactionDelete_hook)) { interactionDelete_hook(gb); return; } HANDOFF(SYM(interactionDelete));
L_4ac3:
...
L_4ada:
  ...
  CYC(b_+380,b_+383); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));
L_4af2:
  ...
  CYC(b_+396,b_+399); if (hook_is(gb, SYM(interactionDelete), interactionDelete_hook)) { interactionDelete_hook(gb); return; } HANDOFF(SYM(interactionDelete));
L_4b02:
...
L_4b30:
  ...
  if (!(F & FZ)) { CYCT(b_+450,b_+453); if (hook_is(gb, SYM(interactionDelete), interactionDelete_hook)) { interactionDelete_hook(gb); return; } HANDOFF(SYM(interactionDelete)); } CYC(b_+450,b_+453);
  ...
  CYC(b_+480,b_+483); if (hook_is(gb, SYM(objectSetVisiblec2), objectSetVisiblec2_hook)) { objectSetVisiblec2_hook(gb); return; } HANDOFF(SYM(objectSetVisiblec2));
L_4b56:
  ...
  if ((F & FC)) { CYCT(b_+500,b_+503); if (hook_is(gb, SYM(interactionDelete), interactionDelete_hook)) { interactionDelete_hook(gb); return; } HANDOFF(SYM(interactionDelete)); } CYC(b_+500,b_+503);
...
L_4bbd:
  ...
  CYC(b_+599,b_+602); if (hook_is(gb, SYM(interactionDelete), interactionDelete_hook)) { interactionDelete_hook(gb); return; } HANDOFF(SYM(interactionDelete));
L_4bcd:
...
L_4bde:
  ...
  CYC(b_+639,b_+642); if (hook_is(gb, SYM(objectSetInvisible), objectSetInvisible_hook)) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));
L_4bf5:
...
L_4c02:
  ...
  CYC(b_+692,b_+695); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));
L_4c2a:
  ...
  CYC(b_+700,b_+703); if (hook_is(gb, SYM(interactionDelete), interactionDelete_hook)) { interactionDelete_hook(gb); return; } HANDOFF(SYM(interactionDelete));
}
...
L_4c9d:
  ...
  if ((F & FZ)) { CYCT(b_+820,b_+823); if (hook_is(gb, SYM(objectCheckCollidedWithLink_notDeadAndNotGrabbing), objectCheckCollidedWithLink_notDeadAndNotGrabbing_hook)) { objectCheckCollidedWithLink_notDeadAndNotGrabbing_hook(gb); return; } HANDOFF(SYM(objectCheckCollidedWithLink_notDeadAndNotGrabbing)); } CYC(b_+820,b_+823);
