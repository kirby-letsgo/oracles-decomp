...
collisionOccurred:
  ...
  CYC(b_+90, b_+93); if (hook_enabled_at(SYM(playSound_b00))) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
normalStatus:
...
void mergedTwinrova_state9_hook(GB *gb) {
  ...
  if (!(F & FC)) { CYCT(b_+16, b_+19); if (hook_enabled_at(SYM(ecom_moveTowardPosition_b10))) { ecom_moveTowardPosition_b10_hook(gb); return; } HANDOFF(SYM(ecom_moveTowardPosition_b10)); } CYC(b_+16, b_+19);  // jp nc,ecom_moveTowardPosition
...
substate0_swapSubid:
  ...
  CYC(b_+48, b_+51); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
substate1:
...
substate1_swapSubid:
  ...
  CYC(b_+86, b_+89); if (hook_enabled_at(SYM(playSound_b00))) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
substate2:
...
substate3:
  ...
  CYC(b_+117, b_+120); if (hook_enabled_at(SYM(fadeinFromWhiteWithDelay))) { fadeinFromWhiteWithDelay_hook(gb); return; } HANDOFF(SYM(fadeinFromWhiteWithDelay));  // jp fadeinFromWhiteWithDelay
substate4:
...
chooseTargetPositionIndex:
  ...
  CYC(b_+29, b_+32); if (hook_enabled_at(SYM(playSound_b00))) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
...
flameAttack_substate1:
  ...
  if (!(F & FZ)) { CYCT(b_+50, b_+53); if (hook_enabled_at(SYM(enemyAnimate))) { enemyAnimate_hook(gb); return; } HANDOFF(SYM(enemyAnimate)); } CYC(b_+50, b_+53);  // jp nz,enemyAnimate
  ...
  CYC(b_+59, b_+62); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
...
doneAttack:
  ...
  CYC(b_+84, b_+87); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
keeseAttack:
...
keeseAttack_substate0:
  ...
  CYC(b_+108, b_+111); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
keeseAttack_substate1:
  CALL_C(b_+111, ecom_decCounter1_b10_hook, SYM(ecom_decCounter1_b10), b_+114);
  if (!(F & FZ)) { CYCT(b_+114, b_+117); if (hook_enabled_at(SYM(enemyAnimate))) { enemyAnimate_hook(gb); return; } HANDOFF(SYM(enemyAnimate)); } CYC(b_+114, b_+117);  // jp nz,enemyAnimate
  ...
  CYC(b_+144, b_+147); if (hook_enabled_at(SYM(objectCopyPositionWithOffset))) { objectCopyPositionWithOffset_hook(gb); return; } HANDOFF(SYM(objectCopyPositionWithOffset));  // jp objectCopyPositionWithOffset
doneSpawningKeese:
  ...
  CYC(b_+154, b_+157); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
...
substate0:
  ...
  if (!(F & FZ)) { CYCT(b_+10, b_+13); if (hook_enabled_at(SYM(enemyAnimate))) { enemyAnimate_hook(gb); return; } HANDOFF(SYM(enemyAnimate)); } CYC(b_+10, b_+13);  // jp nz,enemyAnimate
...
readAngle:
  ...
  CYC(b_+64, b_+67); if (hook_enabled_at(SYM(objectCopyPositionWithOffset))) { objectCopyPositionWithOffset_hook(gb); return; } HANDOFF(SYM(objectCopyPositionWithOffset));  // jp objectCopyPositionWithOffset
doneSpawningProjectiles:
  ...
  CYC(b_+79, b_+82); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
substate1:
...
void mergedTwinrova_iceRoom_stateF_hook(GB *gb) {
  ...
  if (!(F & FC)) { CYCT(b_+9, b_+12); if (hook_enabled_at(SYM(ecom_moveTowardPosition_b10))) { ecom_moveTowardPosition_b10_hook(gb); return; } HANDOFF(SYM(ecom_moveTowardPosition_b10)); } CYC(b_+9, b_+12);  // jp nc,ecom_moveTowardPosition
...
substate1:
  ...
  if (!(F & FZ)) { CYCT(b_+59, b_+62); if (hook_enabled_at(SYM(ecom_flickerVisibility_b10))) { ecom_flickerVisibility_b10_hook(gb); return; } HANDOFF(SYM(ecom_flickerVisibility_b10)); } CYC(b_+59, b_+62);  // jp nz,ecom_flickerVisibility
...
substate2:
  ...
  CYC(b_+88, b_+91); if (hook_enabled_at(SYM(playSound_b00))) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
substate3:
