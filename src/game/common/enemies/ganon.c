...
#undef CYC
#undef CYCT
#define CYC(from, to) burn_rom(gb, SYMBANK(enemyCode04), (from), (to), false)
#define CYCT(from, to) burn_rom(gb, SYMBANK(enemyCode04), (from), (to), true)
...
void enemyCode04_hook(GB *gb) {
  ...
  CYC(b_+64, b_+67); SET_BC((SYM(updateEnemy) + 7));  // ld bc,TX_2f0e
...
void ganon_state_uninitialized_hook(GB *gb) {
  ...
  CYC(b_+138, SYM(ganon_state1)); if (hook_enabled_at(SYM(fadeinFromWhite))) { fadeinFromWhite_hook(gb); return; } HANDOFF(SYM(fadeinFromWhite));  // jp fadeinFromWhite
}
...
void ganon_state2_hook(GB *gb) {
  ...
  CYC(b_+22, SYM(ganon_state3)); if (hook_enabled_at(SYM(objectSetVisible83))) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
nextState:
  ...
  CYC(b_+31, SYM(ganon_state4)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_state4_hook(GB *gb) {
  ...
  CYC(b_+37, SYM(ganon_state5)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_state5_hook(GB *gb) {
  ...
  CYC(b_+28, SYM(ganon_state6)); if (hook_enabled_at(SYM(clearPaletteFadeVariablesAndRefreshPalettes))) { clearPaletteFadeVariablesAndRefreshPalettes_hook(gb); return; } HANDOFF(SYM(clearPaletteFadeVariablesAndRefreshPalettes));  // jp clearPaletteFadeVariablesAndRefreshPalettes
}
...
void ganon_state6_hook(GB *gb) {
  ...
  CYC(b_+24, b_+27); SET_BC((SYM(updateEnemy) + 6));  // ld bc,TX_2f0d
  CALL_C(b_+27, showText_hook, SYM(showText), b_+30);
  CYC(b_+30, b_+32); A = 0x02;  // ld a,$02
  CYC(b_+32, SYM(ganon_state7)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_state7_hook(GB *gb) {
  ...
  CYC(b_+8, SYM(ganon_state8)); ganon_decideNextMove_hook(gb); return;  // jp ganon_decideNextMove
}
...
void ganon_state8_substate1_hook(GB *gb) {
  ...
  CYC(b_+11, SYM(ganon_state8_substate2)); if (hook_enabled_at(SYM(objectSetInvisible))) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
void ganon_state8_substate2_hook(GB *gb) {
  ...
  CYC(b_+5, b_+6); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));  // inc (hl)
  CYC(b_+6, SYM(ganon_state8_substate3)); ganon_updateTeleportVarsAndPlaySound_hook(gb); return;  // jp ganon_updateTeleportVarsAndPlaySound
}
...
void ganon_state8_substate3_hook(GB *gb) {
  ...
  CYC(b_+20, SYM(ganon_state8_substate4)); if (hook_enabled_at(SYM(objectSetVisible83))) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
void ganon_state8_substate4_hook(GB *gb) {
  ...
  CYC(b_+10, SYM(ganon_state8_substate5)); ganon_loadGfxHeader_hook(gb); return;  // jp ganon_loadGfxHeader
}
...
void ganon_state8_substate5_hook(GB *gb) {
  ...
  CYC(b_+19, SYM(ganon_state8_substate6)); ganon_state8_spawnProjectile_hook(gb); return;  // jr ganon_state8_spawnProjectile
}
...
checkAttackDone:
  ...
  CYC(b_+18, b_+21); SET_BC((SYM(hexToDec) + 11));  // ldbc $02,SPEED_280
  CALL_C(b_+21, ganon_state8_spawnProjectile_hook, SYM(ganon_state8_spawnProjectile), b_+24);
  CYC(b_+24, SYM(ganon_state8_spawnProjectile)); SET_BC(0xfe64);  // ldbc $fe,SPEED_280
...
void ganon_state8_spawnProjectile_hook(GB *gb) {
  ...
  CYC(b_+18, SYM(ganon_state8_substate7)); if (hook_enabled_at(SYM(objectCopyPosition))) { objectCopyPosition_hook(gb); return; } HANDOFF(SYM(objectCopyPosition));  // jp objectCopyPosition
}
...
void ganon_state8_substate7_hook(GB *gb) {
  ...
  CALL_C(b_+0, ecom_decCounter1_b10_hook, SYM(ecom_decCounter1_b10), b_+3);
  if (!(F & FZ)) { RET_TAKEN(b_+3); return; } CYC(b_+3, b_+4);  // ret nz
  CYC(b_+4, SYM(ganon_state9)); ganon_finishAttack_hook(gb); return;  // jp ganon_finishAttack
}
...
void ganon_state9_substate1_hook(GB *gb) {
  ...
  CYC(b_+18, SYM(ganon_state9_substate3)); if (hook_enabled_at(SYM(objectSetInvisible))) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
void ganon_state9_substate3_hook(GB *gb) {
  ...
  CYC(b_+14, SYM(ganon_state9_substate4)); if (hook_enabled_at(SYM(objectSetVisible83))) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
void ganon_state9_substate4__spawnProjectile_hook(GB *gb) {
  ...
  CYC(b_+52, SYM(ganon_state9_substate5)); if (hook_enabled_at(SYM(objectCopyPosition))) { objectCopyPosition_hook(gb); return; } HANDOFF(SYM(objectCopyPosition));  // jp objectCopyPosition
}
...
void ganon_state9_substate5_hook(GB *gb) {
  ...
  CYC(b_+15, SYM(ganon_state9_substate6)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_state9_substate6_hook(GB *gb) {
  ...
  CYC(b_+10, SYM(ganon_state9_substate7)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_state9_substate7_hook(GB *gb) {
  ...
  CALL_C(b_+0, ecom_decCounter1_b10_hook, SYM(ecom_decCounter1_b10), b_+3);
  if (!(F & FZ)) { RET_TAKEN(b_+3); return; } CYC(b_+3, b_+4);  // ret nz
  CYC(b_+4, SYM(ganon_stateA)); ganon_finishAttack_hook(gb); return;  // jp ganon_finishAttack
}
...
void ganon_stateA_substate1_hook(GB *gb) {
  ...
  CYC(b_+8, b_+9); L = E;  // ld l,e
  CYC(b_+9, b_+10); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));  // inc (hl)
  CYC(b_+10, SYM(ganon_stateA_substate2)); if (hook_enabled_at(SYM(objectSetInvisible))) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
void ganon_stateA_substate2_hook(GB *gb) {
  ...
  CYC(b_+10, b_+13); SET_BC((SYM(gfxRegisterStates) + 34));  // ldbc $03,$28
...
setYh:
  ...
  CYC(b_+48, SYM(ganon_stateA_substate3)); ganon_updateTeleportVarsAndPlaySound_hook(gb); return;  // jp ganon_updateTeleportVarsAndPlaySound
}
...
void ganon_stateA_substate3_hook(GB *gb) {
  ...
  CYC(b_+26, SYM(ganon_stateA_substate4)); if (hook_enabled_at(SYM(objectSetVisible83))) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
void ganon_stateA_substate5_hook(GB *gb) {
  ...
  uint16_t sp0_ = gb->sp; (void)sp0_;
  CALL_C(SYM(ganon_stateA_substate5), ecom_decCounter1_b10_hook, SYM(ecom_decCounter1_b10), (SYM(ganon_stateA_substate5) + 3));
  if (!(F & FZ)) { CYCT((SYM(ganon_stateA_substate5) + 3), (SYM(ganon_stateA_substate5) + 5)); goto checkBounds; } CYC((SYM(ganon_stateA_substate5) + 3), (SYM(ganon_stateA_substate5) + 5));  // jr nz,+++
  CYC((SYM(ganon_stateA_substate5) + 5), (SYM(ganon_stateA_substate5) + 7)); mem_wr(gb, HL, 16);  // ld (hl),16
  CYC((SYM(ganon_stateA_substate5) + 7), (SYM(ganon_stateA_substate5) + 8)); L = E;  // ld l,e
  CYC((SYM(ganon_stateA_substate5) + 8), (SYM(ganon_stateA_substate5) + 9)); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));  // inc (hl)
  CYC((SYM(ganon_stateA_substate5) + 9), (SYM(ganon_stateA_substate5) + 11)); A = 0xb6;  // ld a,GFXH_GANON_F
  CALL_C((SYM(ganon_stateA_substate5) + 11), ganon_loadGfxHeader_hook, SYM(ganon_loadGfxHeader), (SYM(ganon_stateA_substate5) + 14));
  CYC((SYM(ganon_stateA_substate5) + 14), (SYM(ganon_stateA_substate5) + 16)); E = 0xb2;  // ld e,Enemy.var32
  CYC((SYM(ganon_stateA_substate5) + 16), (SYM(ganon_stateA_substate5) + 17)); A = mem_rd(gb, DE);  // ld a,(de)
  CYC((SYM(ganon_stateA_substate5) + 17), (SYM(ganon_stateA_substate5) + 19)); alu_add(gb, 0x09);  // add $09
  CYC((SYM(ganon_stateA_substate5) + 19), b_+0); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
checkBounds:
  ...
  CYC(b_+27, SYM(ganon_stateA_substate7)); if (hook_enabled_at(SYM(objectApplySpeed))) { objectApplySpeed_hook(gb); return; } HANDOFF(SYM(objectApplySpeed));  // jp objectApplySpeed
}
...
void ganon_stateA_substate7_hook(GB *gb) {
  ...
  CYC(b_+9, SYM(ganon_stateB)); ganon_finishAttack_hook(gb); return;  // jp ganon_finishAttack
}
...
void ganon_stateB_substate1_hook(GB *gb) {
  ...
  CYC(b_+8, b_+9); L = E;  // ld l,e
  CYC(b_+9, b_+10); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));  // inc (hl)
  CYC(b_+10, SYM(ganon_stateB_substate2)); if (hook_enabled_at(SYM(objectSetInvisible))) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
void ganon_stateB_substate2_hook(GB *gb) {
  ...
  CYC(b_+24, SYM(ganon_stateB_substate3)); ganon_updateTeleportVarsAndPlaySound_hook(gb); return;  // jp ganon_updateTeleportVarsAndPlaySound
}
...
void ganon_stateB_substate3_hook(GB *gb) {
  ...
  CYC(b_+26, SYM(ganon_stateB_substate4)); if (hook_enabled_at(SYM(objectCopyPositionWithOffset))) { objectCopyPositionWithOffset_hook(gb); return; } HANDOFF(SYM(objectCopyPositionWithOffset));  // jp objectCopyPositionWithOffset
}
...
void ganon_stateB_substate4_hook(GB *gb) {
  ...
  CYC(b_+20, SYM(ganon_stateB_substate5)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
shakeAndAdvance:
  ...
  CYC(b_+37, SYM(ganon_stateB_substate6)); if (hook_enabled_at(SYM(playSound_b00))) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
...
nextState:
  ...
  CYC(b_+34, SYM(ganon_stateB_substate7)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_stateB_substate7_hook(GB *gb) {
  ...
  CYC(b_+20, SYM(ganon_stateB_substate8)); if (hook_enabled_at(SYM(objectCopyPositionWithOffset))) { objectCopyPositionWithOffset_hook(gb); return; } HANDOFF(SYM(objectCopyPositionWithOffset));  // jp objectCopyPositionWithOffset
}
...
void ganon_stateB_substate8_hook(GB *gb) {
  ...
  CYC(b_+18, SYM(ganon_stateB_substate9)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_stateB_substate9_hook(GB *gb) {
  ...
  CYC(b_+7, b_+8); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));  // inc (hl)
  CYC(b_+8, b_+10); A = 0x02;  // ld a,$02
  CYC(b_+10, SYM(ganon_stateB_substateA)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_stateB_substateA_hook(GB *gb) {
  ...
  CALL_C(b_+0, ecom_decCounter1_b10_hook, SYM(ecom_decCounter1_b10), b_+3);
  if (!(F & FZ)) { RET_TAKEN(b_+3); return; } CYC(b_+3, b_+4);  // ret nz
  CYC(b_+4, SYM(ganon_stateC)); ganon_finishAttack_hook(gb); return;  // jp ganon_finishAttack
}
...
void ganon_stateC_substate1_hook(GB *gb) {
  ...
  CYC(b_+14, b_+16); L = 0x8d;  // ld l,Enemy.xh
  CYC(b_+16, b_+18); mem_wr(gb, HL, 0x78);  // ld (hl),$78
  CYC(b_+18, SYM(ganon_stateC_substate3)); if (hook_enabled_at(SYM(objectSetInvisible))) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
void ganon_stateC_substate3_hook(GB *gb) {
  ...
  CYC(b_+19, SYM(ganon_stateC_substate4)); if (hook_enabled_at(SYM(playSound_b00))) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
...
nextSubstate:
  ...
  CYC(b_+39, SYM(ganon_stateC_substate5)); if (hook_enabled_at(SYM(fadeoutToBlackWithDelay))) { fadeoutToBlackWithDelay_hook(gb); return; } HANDOFF(SYM(fadeoutToBlackWithDelay));  // jp fadeoutToBlackWithDelay
}
...
void ganon_stateC_substate5_hook(GB *gb) {
  ...
  CYC(b_+13, SYM(ganon_stateC_substate6)); ganon_makeRoomBoundarySolid_hook(gb); return;  // jp ganon_makeRoomBoundarySolid
}
...
loadGfx:
  ...
  CYC(b_+53, SYM(ganon_stateC_substate8)); ganon_updateSeizurePalette_hook(gb); return;  // jp ganon_updateSeizurePalette
}
...
nextSubstate:
  ...
  CYC(b_+51, SYM(ganon_stateC_substate9)); if (hook_enabled_at(SYM(enemySetAnimation))) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_stateC_substate9_hook(GB *gb) {
  ...
  CYC(b_+18, SYM(ganon_stateC_substateA)); if (hook_enabled_at(SYM(loadPaletteHeader))) { loadPaletteHeader_hook(gb); return; } HANDOFF(SYM(loadPaletteHeader));  // jp loadPaletteHeader
}
...
void ganon_stateC_substateA_hook(GB *gb) {
  ...
  CYC(b_+8, SYM(ganon_stateD)); ganon_finishAttack_hook(gb); return;  // jp ganon_finishAttack
}
...
void ganon_stateD_substate3_hook(GB *gb) {
  ...
  CYC(b_+14, SYM(ganon_stateE)); if (hook_enabled_at(SYM(objectSetVisible83))) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
void ganon_stateE_substate0_hook(GB *gb) {
  ...
  CYC(b_+44, SYM(ganon_stateE_substate1)); if (hook_enabled_at(SYM(playSound_b00))) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
...
void ganon_stateE_substate1_hook(GB *gb) {
  ...
  CYC(b_+15, SYM(ganon_stateE_substate2)); if (hook_enabled_at(SYM(fastFadeoutToWhite))) { fastFadeoutToWhite_hook(gb); return; } HANDOFF(SYM(fastFadeoutToWhite));  // jp fastFadeoutToWhite
}
...
void ganon_stateE_substate2_hook(GB *gb) {
  ...
  CYC(b_+17, SYM(ganon_stateE_substate3)); if (hook_enabled_at(SYM(fadeinFromWhiteWithDelay))) { fadeinFromWhiteWithDelay_hook(gb); return; } HANDOFF(SYM(fadeinFromWhiteWithDelay));  // jp fadeinFromWhiteWithDelay
}
...
void ganon_stateE_substate3_hook(GB *gb) {
  ...
  CYC(b_+16, SYM(ganon_loadGfxHeader)); if (hook_enabled_at(SYM(enemyDelete))) { enemyDelete_hook(gb); return; } HANDOFF(SYM(enemyDelete));  // jp enemyDelete
}
...
void ganon_updateTeleportAnimationGoingOut_hook(GB *gb) {
  ...
  CYC(b_+7, SYM(ganon_updateFlickeringXPosition)); alu_sub(gb, B);  // sub b
...
haveDelta:
  ...
  CYC(b_+12, SYM(ganon_updateTeleportVarsAndPlaySound)); if (hook_enabled_at(SYM(ecom_flickerVisibility_b10))) { ecom_flickerVisibility_b10_hook(gb); return; } HANDOFF(SYM(ecom_flickerVisibility_b10));  // jp ecom_flickerVisibility
}
...
void ganon_updateTeleportAnimationComingIn_hook(GB *gb) {
  ...
  CYC(b_+1, b_+3); alu_and(gb, 0x3e);  // and $3e
  CYC(b_+3, b_+4); alu_rrca(gb);  // rrca
  CYC(b_+4, SYM(ganon_finishAttack)); ganon_updateFlickeringXPosition_hook(gb); return;  // jr ganon_updateFlickeringXPosition
}
...
void ganon_finishAttack_hook(GB *gb) {
  ...
  if ((F & FZ)) { CYCT(b_+8, SYM(label_10_135)); ganon_decideNextMove_hook(gb); return; } CYC(b_+8, SYM(label_10_135));  // jr z,ganon_decideNextMove
...
void ganon_decideTeleportLocationAndCounter_hook(GB *gb) {
  ...
  uint16_t sp0_ = gb->sp; (void)sp0_;
  CYC(b_+0, b_+3); SET_BC((SYM(drawAllSpritesUnconditionally__loop) + 78));  // ld bc,$0e0f
...
void ganon_updateSeizurePalette_hook(GB *gb) {
  ...
  CYC(b_+28, SYM(ganon_setTileReplacementMode)); if (hook_enabled_at(SYM(loadPaletteHeader))) { loadPaletteHeader_hook(gb); return; } HANDOFF(SYM(loadPaletteHeader));  // jp loadPaletteHeader
}
