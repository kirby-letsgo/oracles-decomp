...
void enemyCode04__normalStatus_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (ganon_jump_table(gb));
    if (jt_ == SYM(ganon_state_uninitialized) && hook_is(gb, SYM(ganon_state_uninitialized), ganon_state_uninitialized_hook)) { ganon_state_uninitialized_hook(gb); return; }
    else if (jt_ == SYM(ganon_state1) && hook_is(gb, SYM(ganon_state1), ganon_state1_hook)) { ganon_state1_hook(gb); return; }
    else if (jt_ == SYM(ganon_state2) && hook_is(gb, SYM(ganon_state2), ganon_state2_hook)) { ganon_state2_hook(gb); return; }
    else if (jt_ == SYM(ganon_state3) && hook_is(gb, SYM(ganon_state3), ganon_state3_hook)) { ganon_state3_hook(gb); return; }
    else if (jt_ == SYM(ganon_state4) && hook_is(gb, SYM(ganon_state4), ganon_state4_hook)) { ganon_state4_hook(gb); return; }
    else if (jt_ == SYM(ganon_state5) && hook_is(gb, SYM(ganon_state5), ganon_state5_hook)) { ganon_state5_hook(gb); return; }
    else if (jt_ == SYM(ganon_state6) && hook_is(gb, SYM(ganon_state6), ganon_state6_hook)) { ganon_state6_hook(gb); return; }
    else if (jt_ == SYM(ganon_state7) && hook_is(gb, SYM(ganon_state7), ganon_state7_hook)) { ganon_state7_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8) && hook_is(gb, SYM(ganon_state8), ganon_state8_hook)) { ganon_state8_hook(gb); return; }
    else if (jt_ == SYM(ganon_state9) && hook_is(gb, SYM(ganon_state9), ganon_state9_hook)) { ganon_state9_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateA) && hook_is(gb, SYM(ganon_stateA), ganon_stateA_hook)) { ganon_stateA_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB) && hook_is(gb, SYM(ganon_stateB), ganon_stateB_hook)) { ganon_stateB_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC) && hook_is(gb, SYM(ganon_stateC), ganon_stateC_hook)) { ganon_stateC_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateD) && hook_is(gb, SYM(ganon_stateD), ganon_stateD_hook)) { ganon_stateD_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateE) && hook_is(gb, SYM(ganon_stateE), ganon_stateE_hook)) { ganon_stateE_hook(gb); return; }
...
void enemyCode04_hook(GB *gb) {
  ...
  CYC(b_+67, b_+70); if (hook_is(gb, SYM(showText), showText_hook)) { showText_hook(gb); return; } HANDOFF(SYM(showText));  // jp showText
normalStatus:
...
void ganon_state_uninitialized_hook(GB *gb) {
  ...
  CYC(b_+138, b_+141); if (hook_is(gb, SYM(fadeinFromWhite), fadeinFromWhite_hook)) { fadeinFromWhite_hook(gb); return; } HANDOFF(SYM(fadeinFromWhite));  // jp fadeinFromWhite
}
...
void ganon_state2_hook(GB *gb) {
  ...
  if (!(F & FZ)) { CYCT(b_+8, b_+11); if (hook_is(gb, SYM(ecom_flickerVisibility_b10), ecom_flickerVisibility_b10_hook)) { ecom_flickerVisibility_b10_hook(gb); return; } HANDOFF(SYM(ecom_flickerVisibility_b10)); } CYC(b_+8, b_+11);  // jp nz,ecom_flickerVisibility
  ...
  CYC(b_+22, b_+25); if (hook_is(gb, SYM(objectSetVisible83), objectSetVisible83_hook)) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
void ganon_state3_hook(GB *gb) {
  ...
  CYC(b_+13, b_+16); if (hook_is(gb, SYM(enemyAnimate), enemyAnimate_hook)) { enemyAnimate_hook(gb); return; } HANDOFF(SYM(enemyAnimate));  // jp enemyAnimate
nextState:
  ...
  CYC(b_+31, b_+34); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_state4_hook(GB *gb) {
  ...
  if (!(F & FZ)) { CYCT(b_+4, b_+7); if (hook_is(gb, SYM(enemyAnimate), enemyAnimate_hook)) { enemyAnimate_hook(gb); return; } HANDOFF(SYM(enemyAnimate)); } CYC(b_+4, b_+7);  // jp nz,enemyAnimate
  ...
  CYC(b_+37, b_+40); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_state5_hook(GB *gb) {
  ...
  CYC(b_+28, b_+31); if (hook_is(gb, SYM(clearPaletteFadeVariablesAndRefreshPalettes), clearPaletteFadeVariablesAndRefreshPalettes_hook)) { clearPaletteFadeVariablesAndRefreshPalettes_hook(gb); return; } HANDOFF(SYM(clearPaletteFadeVariablesAndRefreshPalettes));  // jp clearPaletteFadeVariablesAndRefreshPalettes
}
...
void ganon_state6_hook(GB *gb) {
  ...
  CYC(b_+32, b_+35); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_state7_hook(GB *gb) {
  ...
  CYC(b_+8, b_+11); TAIL(ganon_decideNextMove);  // jp ganon_decideNextMove
}
...
void ganon_state8_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (ganon_jump_table(gb));
    if (jt_ == SYM(ganon_state8_substate0) && hook_is(gb, SYM(ganon_state8_substate0), ganon_state8_substate0_hook)) { ganon_state8_substate0_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8_substate1) && hook_is(gb, SYM(ganon_state8_substate1), ganon_state8_substate1_hook)) { ganon_state8_substate1_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8_substate2) && hook_is(gb, SYM(ganon_state8_substate2), ganon_state8_substate2_hook)) { ganon_state8_substate2_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8_substate3) && hook_is(gb, SYM(ganon_state8_substate3), ganon_state8_substate3_hook)) { ganon_state8_substate3_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8_substate4) && hook_is(gb, SYM(ganon_state8_substate4), ganon_state8_substate4_hook)) { ganon_state8_substate4_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8_substate5) && hook_is(gb, SYM(ganon_state8_substate5), ganon_state8_substate5_hook)) { ganon_state8_substate5_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8_substate6) && hook_is(gb, SYM(ganon_state8_substate6), ganon_state8_substate6_hook)) { ganon_state8_substate6_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8_substate7) && hook_is(gb, SYM(ganon_state8_substate7), ganon_state8_substate7_hook)) { ganon_state8_substate7_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
void ganon_state8_substate1_hook(GB *gb) {
  ...
  CYC(b_+11, b_+14); if (hook_is(gb, SYM(objectSetInvisible), objectSetInvisible_hook)) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
void ganon_state8_substate2_hook(GB *gb) {
  ...
  CYC(b_+5, b_+6); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));  // inc (hl)
  CYC(b_+6, b_+9); TAIL(ganon_updateTeleportVarsAndPlaySound);  // jp ganon_updateTeleportVarsAndPlaySound
}
...
void ganon_state8_substate3_hook(GB *gb) {
  ...
  CYC(b_+20, b_+23); if (hook_is(gb, SYM(objectSetVisible83), objectSetVisible83_hook)) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
void ganon_state8_substate4_hook(GB *gb) {
  ...
  CYC(b_+10, b_+13); TAIL(ganon_loadGfxHeader);  // jp ganon_loadGfxHeader
}
...
void ganon_state8_substate5_hook(GB *gb) {
  ...
  CYC(b_+19, b_+21); TAIL(ganon_state8_spawnProjectile);  // jr ganon_state8_spawnProjectile
}
...
void ganon_state8_substate6_hook(GB *gb) {
  ...
  CYC(b_+11, b_+14); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
checkAttackDone:
  ...
  TAIL(ganon_state8_spawnProjectile);  // fallthrough
}
...
void ganon_state8_spawnProjectile_hook(GB *gb) {
  ...
  CYC(b_+18, b_+21); if (hook_is(gb, SYM(objectCopyPosition), objectCopyPosition_hook)) { objectCopyPosition_hook(gb); return; } HANDOFF(SYM(objectCopyPosition));  // jp objectCopyPosition
}
...
void ganon_state8_substate7_hook(GB *gb) {
  ...
  CALL_C(b_+0, ecom_decCounter1_b10_hook, SYM(ecom_decCounter1_b10), b_+3);
  if (!(F & FZ)) { RET_TAKEN(b_+3); return; } CYC(b_+3, b_+4);  // ret nz
  CYC(b_+4, b_+7); TAIL(ganon_finishAttack);  // jp ganon_finishAttack
}
...
void ganon_state9_hook(GB *gb) {
  ...
  CYC(b_+2, b_+3); push_effect(gb, b_+3);
  do { uint16_t jt_ = (ganon_jump_table(gb));
    if (jt_ == SYM(ganon_state9_substate0) && hook_is(gb, SYM(ganon_state9_substate0), ganon_state9_substate0_hook)) { ganon_state9_substate0_hook(gb); return; }
    else if (jt_ == SYM(ganon_state9_substate1) && hook_is(gb, SYM(ganon_state9_substate1), ganon_state9_substate1_hook)) { ganon_state9_substate1_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8_substate2) && hook_is(gb, SYM(ganon_state8_substate2), ganon_state8_substate2_hook)) { ganon_state8_substate2_hook(gb); return; }
    else if (jt_ == SYM(ganon_state9_substate3) && hook_is(gb, SYM(ganon_state9_substate3), ganon_state9_substate3_hook)) { ganon_state9_substate3_hook(gb); return; }
    else if (jt_ == SYM(ganon_state9_substate4) && hook_is(gb, SYM(ganon_state9_substate4), ganon_state9_substate4_hook)) { ganon_state9_substate4_hook(gb); return; }
    else if (jt_ == SYM(ganon_state9_substate5) && hook_is(gb, SYM(ganon_state9_substate5), ganon_state9_substate5_hook)) { ganon_state9_substate5_hook(gb); return; }
    else if (jt_ == SYM(ganon_state9_substate6) && hook_is(gb, SYM(ganon_state9_substate6), ganon_state9_substate6_hook)) { ganon_state9_substate6_hook(gb); return; }
    else if (jt_ == SYM(ganon_state9_substate7) && hook_is(gb, SYM(ganon_state9_substate7), ganon_state9_substate7_hook)) { ganon_state9_substate7_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
void ganon_state9_substate1_hook(GB *gb) {
  ...
  CYC(b_+18, b_+21); if (hook_is(gb, SYM(objectSetInvisible), objectSetInvisible_hook)) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
void ganon_state9_substate3_hook(GB *gb) {
  ...
  CYC(b_+14, b_+17); if (hook_is(gb, SYM(objectSetVisible83), objectSetVisible83_hook)) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
void ganon_state9_substate4_hook(GB *gb) {
  ...
  TAIL(ganon_state9_substate4__spawnProjectile);  // fallthrough
}
...
void ganon_state9_substate4__spawnProjectile_hook(GB *gb) {
  ...
  CYC(b_+52, b_+55); if (hook_is(gb, SYM(objectCopyPosition), objectCopyPosition_hook)) { objectCopyPosition_hook(gb); return; } HANDOFF(SYM(objectCopyPosition));  // jp objectCopyPosition
}
...
void ganon_state9_substate5_hook(GB *gb) {
  ...
  CYC(b_+15, b_+18); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_state9_substate6_hook(GB *gb) {
  ...
  CYC(b_+10, b_+13); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_stateA_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (ganon_jump_table(gb));
    if (jt_ == SYM(ganon_state9_substate0) && hook_is(gb, SYM(ganon_state9_substate0), ganon_state9_substate0_hook)) { ganon_state9_substate0_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateA_substate1) && hook_is(gb, SYM(ganon_stateA_substate1), ganon_stateA_substate1_hook)) { ganon_stateA_substate1_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateA_substate2) && hook_is(gb, SYM(ganon_stateA_substate2), ganon_stateA_substate2_hook)) { ganon_stateA_substate2_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateA_substate3) && hook_is(gb, SYM(ganon_stateA_substate3), ganon_stateA_substate3_hook)) { ganon_stateA_substate3_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateA_substate4) && hook_is(gb, SYM(ganon_stateA_substate4), ganon_stateA_substate4_hook)) { ganon_stateA_substate4_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateA_substate5) && hook_is(gb, SYM(ganon_stateA_substate5), ganon_stateA_substate5_hook)) { ganon_stateA_substate5_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateA_substate6) && hook_is(gb, SYM(ganon_stateA_substate6), ganon_stateA_substate6_hook)) { ganon_stateA_substate6_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateA_substate7) && hook_is(gb, SYM(ganon_stateA_substate7), ganon_stateA_substate7_hook)) { ganon_stateA_substate7_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
void ganon_stateA_substate1_hook(GB *gb) {
  ...
  CYC(b_+8, b_+9); L = E;  // ld l,e
  CYC(b_+9, b_+10); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));  // inc (hl)
  CYC(b_+10, b_+13); if (hook_is(gb, SYM(objectSetInvisible), objectSetInvisible_hook)) { objectSetInvisible_hook(gb); return; } HANDOFF(SYM(objectSetInvisible));  // jp objectSetInvisible
}
...
setYh:
  ...
  CYC(b_+48, b_+51); TAIL(ganon_updateTeleportVarsAndPlaySound);  // jp ganon_updateTeleportVarsAndPlaySound
}
...
void ganon_stateA_substate3_hook(GB *gb) {
  ...
  CYC(b_+26, b_+29); if (hook_is(gb, SYM(objectSetVisible83), objectSetVisible83_hook)) { objectSetVisible83_hook(gb); return; } HANDOFF(SYM(objectSetVisible83));  // jp objectSetVisible83
}
...
void ganon_stateA_substate4_hook(GB *gb) {
  ...
  TAIL(ganon_stateA_substate5);  // fallthrough
}
...
void ganon_stateA_substate5_hook(GB *gb) {
  ...
  CYC(b_+19, b_+22); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
checkBounds:
  ...
  CYC((SYM(ganon_stateA_substate6) + 27), (SYM(ganon_stateA_substate6) + 30)); if (hook_is(gb, SYM(objectApplySpeed), objectApplySpeed_hook)) { objectApplySpeed_hook(gb); return; } HANDOFF(SYM(objectApplySpeed));  // jp objectApplySpeed
}
...
checkBounds:
  ...
  CYC(b_+27, b_+30); if (hook_is(gb, SYM(objectApplySpeed), objectApplySpeed_hook)) { objectApplySpeed_hook(gb); return; } HANDOFF(SYM(objectApplySpeed));  // jp objectApplySpeed
}
...
void ganon_stateA_substate7_hook(GB *gb) {
  ...
  CYC(b_+9, b_+12); TAIL(ganon_finishAttack);  // jp ganon_finishAttack
}
...
void ganon_stateB_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (ganon_jump_table(gb));
    if (jt_ == SYM(ganon_state9_substate0) && hook_is(gb, SYM(ganon_state9_substate0), ganon_state9_substate0_hook)) { ganon_state9_substate0_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substate1) && hook_is(gb, SYM(ganon_stateB_substate1), ganon_stateB_substate1_hook)) { ganon_stateB_substate1_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substate2) && hook_is(gb, SYM(ganon_stateB_substate2), ganon_stateB_substate2_hook)) { ganon_stateB_substate2_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substate3) && hook_is(gb, SYM(ganon_stateB_substate3), ganon_stateB_substate3_hook)) { ganon_stateB_substate3_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substate4) && hook_is(gb, SYM(ganon_stateB_substate4), ganon_stateB_substate4_hook)) { ganon_stateB_substate4_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substate5) && hook_is(gb, SYM(ganon_stateB_substate5), ganon_stateB_substate5_hook)) { ganon_stateB_substate5_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substate6) && hook_is(gb, SYM(ganon_stateB_substate6), ganon_stateB_substate6_hook)) { ganon_stateB_substate6_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substate7) && hook_is(gb, SYM(ganon_stateB_substate7), ganon_stateB_substate7_hook)) { ganon_stateB_substate7_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substate8) && hook_is(gb, SYM(ganon_stateB_substate8), ganon_stateB_substate8_hook)) { ganon_stateB_substate8_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substate9) && hook_is(gb, SYM(ganon_stateB_substate9), ganon_stateB_substate9_hook)) { ganon_stateB_substate9_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateB_substateA) && hook_is(gb, SYM(ganon_stateB_substateA), ganon_stateB_substateA_hook)) { ganon_stateB_substateA_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
void ganon_stateB_substate2_hook(GB *gb) {
  ...
  CYC(b_+24, b_+27); TAIL(ganon_updateTeleportVarsAndPlaySound);  // jp ganon_updateTeleportVarsAndPlaySound
}
...
void ganon_stateB_substate3_hook(GB *gb) {
  ...
  CYC(b_+26, b_+29); if (hook_is(gb, SYM(objectCopyPositionWithOffset), objectCopyPositionWithOffset_hook)) { objectCopyPositionWithOffset_hook(gb); return; } HANDOFF(SYM(objectCopyPositionWithOffset));  // jp objectCopyPositionWithOffset
}
...
void ganon_stateB_substate5_hook(GB *gb) {
  ...
  CYC(b_+21, b_+24); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
shakeAndAdvance:
  ...
  CYC(b_+37, b_+40); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
...
nextState:
  ...
  CYC(b_+34, b_+37); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_stateB_substate7_hook(GB *gb) {
  ...
  CYC(b_+20, b_+23); if (hook_is(gb, SYM(objectCopyPositionWithOffset), objectCopyPositionWithOffset_hook)) { objectCopyPositionWithOffset_hook(gb); return; } HANDOFF(SYM(objectCopyPositionWithOffset));  // jp objectCopyPositionWithOffset
}
...
void ganon_stateB_substate8_hook(GB *gb) {
  ...
  CYC(b_+18, b_+21); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_stateC_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (ganon_jump_table(gb));
    if (jt_ == SYM(ganon_state9_substate0) && hook_is(gb, SYM(ganon_state9_substate0), ganon_state9_substate0_hook)) { ganon_state9_substate0_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC_substate1) && hook_is(gb, SYM(ganon_stateC_substate1), ganon_stateC_substate1_hook)) { ganon_stateC_substate1_hook(gb); return; }
    else if (jt_ == SYM(ganon_state8_substate2) && hook_is(gb, SYM(ganon_state8_substate2), ganon_state8_substate2_hook)) { ganon_state8_substate2_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC_substate3) && hook_is(gb, SYM(ganon_stateC_substate3), ganon_stateC_substate3_hook)) { ganon_stateC_substate3_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC_substate4) && hook_is(gb, SYM(ganon_stateC_substate4), ganon_stateC_substate4_hook)) { ganon_stateC_substate4_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC_substate5) && hook_is(gb, SYM(ganon_stateC_substate5), ganon_stateC_substate5_hook)) { ganon_stateC_substate5_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC_substate6) && hook_is(gb, SYM(ganon_stateC_substate6), ganon_stateC_substate6_hook)) { ganon_stateC_substate6_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC_substate7) && hook_is(gb, SYM(ganon_stateC_substate7), ganon_stateC_substate7_hook)) { ganon_stateC_substate7_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC_substate8) && hook_is(gb, SYM(ganon_stateC_substate8), ganon_stateC_substate8_hook)) { ganon_stateC_substate8_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC_substate9) && hook_is(gb, SYM(ganon_stateC_substate9), ganon_stateC_substate9_hook)) { ganon_stateC_substate9_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateC_substateA) && hook_is(gb, SYM(ganon_stateC_substateA), ganon_stateC_substateA_hook)) { ganon_stateC_substateA_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
void ganon_stateC_substate3_hook(GB *gb) {
  ...
  CYC(b_+19, b_+22); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
...
nextSubstate:
  ...
  CYC(b_+39, b_+42); if (hook_is(gb, SYM(fadeoutToBlackWithDelay), fadeoutToBlackWithDelay_hook)) { fadeoutToBlackWithDelay_hook(gb); return; } HANDOFF(SYM(fadeoutToBlackWithDelay));  // jp fadeoutToBlackWithDelay
}
...
void ganon_stateC_substate5_hook(GB *gb) {
  ...
  CYC(b_+13, b_+16); TAIL(ganon_makeRoomBoundarySolid);  // jp ganon_makeRoomBoundarySolid
}
...
void ganon_stateC_substate6_hook(GB *gb) {
  ...
  CYC(b_+27, b_+30); if (hook_is(gb, SYM(fadeinFromBlack), fadeinFromBlack_hook)) { fadeinFromBlack_hook(gb); return; } HANDOFF(SYM(fadeinFromBlack));  // jp fadeinFromBlack
}
...
void ganon_stateC_substate7_hook(GB *gb) {
  ...
  CYC(b_+25, b_+28); if (hook_is(gb, SYM(fastFadeoutToWhite), fastFadeoutToWhite_hook)) { fastFadeoutToWhite_hook(gb); return; } HANDOFF(SYM(fastFadeoutToWhite));  // jp fastFadeoutToWhite
checkCounter1:
  ...
  CYC(b_+41, b_+44); TAIL(ganon_loadGfxHeader);  // jp ganon_loadGfxHeader
loadGfx:
  ...
  CYC(b_+53, b_+56); TAIL(ganon_updateSeizurePalette);  // jp ganon_updateSeizurePalette
}
...
void ganon_stateC_substate8_hook(GB *gb) {
  ...
  CYC(b_+40, b_+43); if (hook_is(gb, SYM(objectCopyPosition), objectCopyPosition_hook)) { objectCopyPosition_hook(gb); return; } HANDOFF(SYM(objectCopyPosition));  // jp objectCopyPosition
nextSubstate:
  ...
  CYC(b_+51, b_+54); if (hook_is(gb, SYM(enemySetAnimation), enemySetAnimation_hook)) { enemySetAnimation_hook(gb); return; } HANDOFF(SYM(enemySetAnimation));  // jp enemySetAnimation
}
...
void ganon_stateC_substate9_hook(GB *gb) {
  ...
  CYC(b_+18, b_+21); if (hook_is(gb, SYM(loadPaletteHeader), loadPaletteHeader_hook)) { loadPaletteHeader_hook(gb); return; } HANDOFF(SYM(loadPaletteHeader));  // jp loadPaletteHeader
}
...
void ganon_stateC_substateA_hook(GB *gb) {
  ...
  CYC(b_+8, b_+11); TAIL(ganon_finishAttack);  // jp ganon_finishAttack
}
...
void ganon_stateD_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (ganon_jump_table(gb));
    ...
    else if (jt_ == SYM(ganon_stateD_substate3) && hook_is(gb, SYM(ganon_stateD_substate3), ganon_stateD_substate3_hook)) { ganon_stateD_substate3_hook(gb); return; }
    else if (jt_ == SYM(ganon_finishAttack) && hook_is(gb, SYM(ganon_finishAttack), ganon_finishAttack_hook)) { ganon_finishAttack_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
void ganon_stateE_hook(GB *gb) {
  ...
  CYC(b_+2, b_+3); push_effect(gb, b_+3);
  do { uint16_t jt_ = (ganon_jump_table(gb));
    if (jt_ == SYM(ganon_stateE_substate0) && hook_is(gb, SYM(ganon_stateE_substate0), ganon_stateE_substate0_hook)) { ganon_stateE_substate0_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateE_substate1) && hook_is(gb, SYM(ganon_stateE_substate1), ganon_stateE_substate1_hook)) { ganon_stateE_substate1_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateE_substate2) && hook_is(gb, SYM(ganon_stateE_substate2), ganon_stateE_substate2_hook)) { ganon_stateE_substate2_hook(gb); return; }
    else if (jt_ == SYM(ganon_stateE_substate3) && hook_is(gb, SYM(ganon_stateE_substate3), ganon_stateE_substate3_hook)) { ganon_stateE_substate3_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
}
...
void ganon_stateE_substate0_hook(GB *gb) {
  ...
  uint16_t sp0_ = gb->sp; (void)sp0_;
  CALL_C(b_+0, ecom_decCounter1_b10_hook, SYM(ecom_decCounter1_b10), b_+3);
  if (!(F & FZ)) { CYCT(b_+3, b_+6); if (hook_is(gb, SYM(ecom_flickerVisibility_b10), ecom_flickerVisibility_b10_hook)) { ecom_flickerVisibility_b10_hook(gb); return; } HANDOFF(SYM(ecom_flickerVisibility_b10)); } CYC(b_+3, b_+6);  // jp nz,ecom_flickerVisibility
  CYC(b_+6, b_+7); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));  // inc (hl)
  ...
  CYC(b_+44, b_+47); if (hook_is(gb, SYM(playSound_b00), playSound_b00_hook)) { playSound_b00_hook(gb); return; } HANDOFF(SYM(playSound_b00));  // jp playSound
}
...
void ganon_stateE_substate1_hook(GB *gb) {
  ...
  CYC(b_+15, b_+18); if (hook_is(gb, SYM(fastFadeoutToWhite), fastFadeoutToWhite_hook)) { fastFadeoutToWhite_hook(gb); return; } HANDOFF(SYM(fastFadeoutToWhite));  // jp fastFadeoutToWhite
}
...
void ganon_stateE_substate2_hook(GB *gb) {
  ...
  CYC(b_+17, b_+20); if (hook_is(gb, SYM(fadeinFromWhiteWithDelay), fadeinFromWhiteWithDelay_hook)) { fadeinFromWhiteWithDelay_hook(gb); return; } HANDOFF(SYM(fadeinFromWhiteWithDelay));  // jp fadeinFromWhiteWithDelay
}
...
void ganon_stateE_substate3_hook(GB *gb) {
  ...
  CYC(b_+16, b_+19); if (hook_is(gb, SYM(enemyDelete), enemyDelete_hook)) { enemyDelete_hook(gb); return; } HANDOFF(SYM(enemyDelete));  // jp enemyDelete
}
...
void ganon_updateTeleportAnimationGoingOut_hook(GB *gb) {
  ...
  TAIL(ganon_updateFlickeringXPosition);  // fallthrough
}
...
haveDelta:
  ...
  CYC(b_+12, b_+15); if (hook_is(gb, SYM(ecom_flickerVisibility_b10), ecom_flickerVisibility_b10_hook)) { ecom_flickerVisibility_b10_hook(gb); return; } HANDOFF(SYM(ecom_flickerVisibility_b10));  // jp ecom_flickerVisibility
}
...
void ganon_updateTeleportAnimationComingIn_hook(GB *gb) {
  ...
  CYC(b_+1, b_+3); alu_and(gb, 0x3e);  // and $3e
  CYC(b_+3, b_+4); alu_rrca(gb);  // rrca
  CYC(b_+4, b_+6); TAIL(ganon_updateFlickeringXPosition);  // jr ganon_updateFlickeringXPosition
}
...
void ganon_updateSeizurePalette_hook(GB *gb) {
  ...
  CYC(b_+28, b_+31); if (hook_is(gb, SYM(loadPaletteHeader), loadPaletteHeader_hook)) { loadPaletteHeader_hook(gb); return; } HANDOFF(SYM(loadPaletteHeader));  // jp loadPaletteHeader
}
