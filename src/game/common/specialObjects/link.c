...
void overworldSwimmingState1_hook(GB *gb) {
  ...
  uint16_t sp0_ = gb->sp;
  CALL_C(b_+O(0), linkCancelAllItemUsage_hook, SYM(linkCancelAllItemUsage), b_+OE(3));
  CALL_C(b_+O(3), linkSetSwimmingSpeed_hook, SYM(linkSetSwimmingSpeed), b_+OE(6));
  if (game_seasons) {
    CYC(b_+S(6), b_+S(8)); L = 0x06;
    CYC(b_+S(8), b_+S(10)); mem_wr(gb, HL, 0x0a);
  } else {
...
L_56bf:
  CYC(b_+O(18), b_+OE(21)); A = mem_rd(gb, wLinkSwimmingState);
  CYC(b_+O(21), b_+OE(23)); alu_bit(gb, 6, A);
  if (!(F & FZ)) { CYCT(b_+O(23), b_+OE(25)); goto L_56d8; } CYC(b_+O(23), b_+OE(25));
  if (!game_seasons) {
  ...
  CYC(b_+O(30), b_+OE(32)); A = 0x2e;
  CALL_C(b_+O(32), checkTreasureObtained_hook, SYM(checkTreasureObtained), b_+OE(35));
  CYC(b_+O(35), b_+OE(37)); B = 0x0b;
  if ((F & FC)) { CYCT(b_+O(37), b_+OE(39)); goto L_56f8; } CYC(b_+O(37), b_+OE(39));
L_56d4:
  CYC(b_+O(39), b_+OE(41)); C = 0x88;
  CYC(b_+O(41), b_+OE(43)); goto L_56da;
L_56d8:
  CYC(b_+O(43), b_+OE(45)); C = 0x78;
L_56da:
  CYC(b_+O(45), b_+OE(47)); A = 0x02;
  CYC(b_+O(47), b_+OE(50)); mem_wr(gb, wLinkForceState, A);
  CYC(b_+O(50), b_+OE(52)); A = 0x04;
  CYC(b_+O(52), b_+OE(55)); mem_wr(gb, wLinkStateParameter, A);
  CYC(b_+O(55), b_+OE(57)); A = 0x80;
  CYC(b_+O(57), b_+OE(60)); mem_wr(gb, wcc92, A);
  CYC(b_+O(60), b_+OE(61)); H = D;
  CYC(b_+O(61), b_+OE(63)); L = 0x2b;
  CYC(b_+O(63), b_+OE(64)); mem_wr(gb, HL, C);
  CYC(b_+O(64), b_+OE(66)); L = 0x24;
  CYC(b_+O(66), b_+OE(68)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) & ~(1 << 7)));
  CYC(b_+O(68), b_+OE(70)); A = 0x5f;
  CALL_C(b_+O(70), playSound_b00_hook, SYM(playSound_b00), b_+OE(73));
  CYC(b_+O(73), b_+OE(75)); B = 0x0a;
L_56f8:
  CYC(b_+O(75), b_+OE(78)); SET_HL(wLinkSwimmingState);
  CYC(b_+O(78), b_+OE(79)); A = mem_rd(gb, HL);
  CYC(b_+O(79), b_+OE(81)); alu_and(gb, 0xf0);
  CYC(b_+O(81), b_+OE(83)); alu_or(gb, 0x02);
  CYC(b_+O(83), b_+OE(84)); mem_wr(gb, HL, A);
  CYC(b_+O(84), b_+OE(85)); A = B;
  CALL_C(b_+O(85), specialObjectSetAnimation_hook, SYM(specialObjectSetAnimation), b_+OE(88));
  CYC(b_+O(88), b_+OE(91)); TAIL(linkCreateSplash);
}
...
void linkUpdateSwimming_sidescroll_hook(GB *gb) {
  ...
  uint16_t sp0_ = gb->sp;
  CYC(b_+O(0), b_+OE(3)); A = mem_rd(gb, wLinkSwimmingState);
  CYC(b_+O(3), b_+OE(5)); alu_and(gb, 0x0f);
  if ((F & FZ)) { CYCT(b_+O(5), b_+OE(7)); goto L_5870; } CYC(b_+O(5), b_+OE(7));
  CYC(b_+O(7), b_+OE(10)); SET_HL(wcc95);
  CYC(b_+O(10), b_+OE(12)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) & ~(1 << 4)));
  CYC(b_+O(12), b_+OE(13)); push_effect(gb, b_+OE(13));
  do { uint16_t jt_ = (link_jump_table(gb));
    if (jt_ == b_+O(21)) { goto L_5870; }
    else if (jt_ == b_+O(24)) { goto L_5873; }
    else if (jt_ == b_+O(69)) { goto L_58a0; }
    else if (jt_ == SYM(linkUpdateDrowning) && hook_is(gb, SYM(linkUpdateDrowning), linkUpdateDrowning_hook)) { linkUpdateDrowning_hook(gb); return; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
L_5870:
  CYC(b_+O(21), b_+OE(24)); TAIL(initLinkState);
L_5873:
  CALL_C(b_+O(24), linkCancelAllItemUsage_hook, SYM(linkCancelAllItemUsage), b_+OE(27));
  CYC(b_+O(27), b_+OE(30)); SET_HL(wLinkSwimmingState);
  CYC(b_+O(30), b_+OE(31)); mem_wr(gb, HL, alu_inc8(gb, mem_rd(gb, HL)));
  CALL_C(b_+O(31), linkSetSwimmingSpeed_hook, SYM(linkSetSwimmingSpeed), b_+OE(34));
  CALL_C(b_+O(34), objectSetVisiblec1_hook, SYM(objectSetVisiblec1), b_+OE(37));
  CYC(b_+O(37), b_+OE(39)); A = 0x2e;
  CALL_C(b_+O(39), checkTreasureObtained_hook, SYM(checkTreasureObtained), b_+OE(42));
  if (!(F & FC)) { CYCT(b_+O(42), b_+OE(44)); goto L_5896; } CYC(b_+O(42), b_+OE(44));
  if (game_seasons) { CYC(b_+S(44), b_+S(46)); A = 0x17; CYC(b_+S(46), b_+S(48)); goto L_589d; }
  if (!game_seasons) {      // the mermaid suit swims with its own animation
...
L_5896:
  CYC(b_+O(59), b_+OE(61)); A = 0x03;
  CYC(b_+O(61), b_+OE(64)); mem_wr(gb, wLinkSwimmingState, A);
  CYC(b_+O(64), b_+OE(66)); A = 0x0a;
L_589d:
  CYC(b_+O(66), b_+OE(69)); TAIL(specialObjectSetAnimation);
L_58a0:
  CYC(b_+O(69), b_+OE(70)); alu_xor(gb, A);
  CYC(b_+O(70), b_+OE(73)); mem_wr(gb, wLinkInAir, A);
  CYC(b_+O(73), b_+OE(74)); H = D;
  CYC(b_+O(74), b_+OE(76)); L = 0x24;
  CYC(b_+O(76), b_+OE(78)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) | (1 << 7)));
  CYC(b_+O(78), b_+OE(81)); A = mem_rd(gb, wLinkImmobilized);
  CYC(b_+O(81), b_+OE(82)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(82), b_+OE(84)); goto L_58d8; } CYC(b_+O(82), b_+OE(84));
  CYC(b_+O(84), b_+OE(86)); L = 0x08;
  CYC(b_+O(86), b_+OE(89)); A = mem_rd(gb, wLinkAngle);
  CYC(b_+O(89), b_+OE(90)); alu_add(gb, A);
  if ((F & FC)) { CYCT(b_+O(90), b_+OE(92)); goto L_58c2; } CYC(b_+O(90), b_+OE(92));
  CYC(b_+O(92), b_+OE(93)); C = A;
  CYC(b_+O(93), b_+OE(95)); alu_and(gb, 0x18);
  if ((F & FZ)) { CYCT(b_+O(95), b_+OE(97)); goto L_58c2; } CYC(b_+O(95), b_+OE(97));
  CYC(b_+O(97), b_+OE(98)); A = C;
  CYC(b_+O(98), b_+OE(100)); A = alu_swap(gb, A);
  CYC(b_+O(100), b_+OE(102)); alu_and(gb, 0x03);
  CYC(b_+O(102), b_+OE(103)); mem_wr(gb, HL, A);
L_58c2:
  CYC(b_+O(103), b_+OE(105)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) | (1 << 0)));
  if (!game_seasons) {
...
L_58cf:
  CALL_C(b_+O(116), linkUpdateFlippersSpeed_hook, SYM(linkUpdateFlippersSpeed), b_+OE(119));
  CALL_C(b_+O(119), func_5933_hook, SYM(func_5933), b_+OE(122));
L_58d5:
  CALL_C(b_+O(122), specialObjectUpdatePosition_hook, SYM(specialObjectUpdatePosition), b_+OE(125));
L_58d8:
  CYC(b_+O(125), b_+OE(126)); H = D;
  CYC(b_+O(126), b_+OE(128)); L = 0x07;
  CYC(b_+O(128), b_+OE(129)); mem_wr(gb, HL, alu_dec8(gb, mem_rd(gb, HL)));
  CYC(b_+O(129), b_+OE(131)); alu_bit(gb, 7, mem_rd(gb, HL));
  if ((F & FZ)) { CYCT(b_+O(131), b_+OE(133)); goto L_58ed; } CYC(b_+O(131), b_+OE(133));
  CALL_C(b_+O(133), getRandomNumber_hook, SYM(getRandomNumber), b_+OE(136));
  CYC(b_+O(136), b_+OE(138)); alu_and(gb, 0x1f);
  CYC(b_+O(138), b_+OE(140)); alu_add(gb, 0x32);
  CYC(b_+O(140), b_+OE(141)); mem_wr(gb, HL, A);
  CYC(b_+O(141), b_+OE(143)); B = 0x91;
  CALL_C(b_+O(143), objectCreateInteractionWithSubid00_hook, SYM(objectCreateInteractionWithSubid00), b_+OE(146));
L_58ed:
  CYC(b_+O(146), b_+OE(149)); TAIL(specialObjectAnimate);
}

void linkState01_sidescroll_hook(GB *gb) {
  BASE(linkState01_sidescroll);
  uint16_t sp0_ = gb->sp;
  CALL_C(b_+O(0), sidescrollUpdateActiveTile_hook, SYM(sidescrollUpdateActiveTile), b_+OE(3));
  CYC(b_+O(3), b_+OE(6)); A = mem_rd(gb, wActiveTileType);
  CYC(b_+O(6), b_+OE(8)); alu_bit(gb, 5, A);
  if ((F & FZ)) { CYCT(b_+O(8), b_+OE(10)); goto L_59dc; } CYC(b_+O(8), b_+OE(10));
  if (!game_seasons) {
    CYC(b_+10, b_+11); H = D;
...
L_59cd:
  CYC(b_+O(19), b_+OE(22)); A = mem_rd(gb, wLinkSwimmingState);
  CYC(b_+O(22), b_+OE(23)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(23), b_+OE(25)); goto L_5a00; } CYC(b_+O(23), b_+OE(25));
  CYC(b_+O(25), b_+OE(26)); A = alu_inc8(gb, A);
  CYC(b_+O(26), b_+OE(29)); mem_wr(gb, wLinkSwimmingState, A);
  CALL_C(b_+O(29), linkCreateSplash_hook, SYM(linkCreateSplash), b_+OE(32));
  CYC(b_+O(32), b_+OE(34)); goto L_5a00;
L_59dc:
  CYC(b_+O(34), b_+OE(37)); SET_HL(wLinkSwimmingState);
  CYC(b_+O(37), b_+OE(38)); A = mem_rd(gb, HL);
  CYC(b_+O(38), b_+OE(40)); mem_wr(gb, HL, 0x00);
  CYC(b_+O(40), b_+OE(41)); alu_or(gb, A);
  if ((F & FZ)) { CYCT(b_+O(41), b_+OE(43)); goto L_5a00; } CYC(b_+O(41), b_+OE(43));
  CYC(b_+O(43), b_+OE(46)); A = mem_rd(gb, wLastActiveTileType);
  CYC(b_+O(46), b_+OE(48)); alu_cp(gb, 0x30);
  if ((F & FZ)) { CYCT(b_+O(48), b_+OE(50)); goto L_5a00; } CYC(b_+O(48), b_+OE(50));
  CYC(b_+O(50), b_+OE(52)); A = 0x02;
  CYC(b_+O(52), b_+OE(55)); mem_wr(gb, wLinkInAir, A);
  CALL_C(b_+O(55), linkCreateSplash_hook, SYM(linkCreateSplash), b_+OE(58));
  CYC(b_+O(58), b_+OE(61)); SET_BC(0xfe60);
  CALL_C(b_+O(61), objectSetSpeedZ_hook, SYM(objectSetSpeedZ), b_+OE(64));
  CYC(b_+O(64), b_+OE(67)); A = mem_rd(gb, wLinkAngle);
  CYC(b_+O(67), b_+OE(69)); L = 0x09;
  CYC(b_+O(69), b_+OE(70)); mem_wr(gb, HL, A);
L_5a00:
  CALL_C(b_+O(70), checkUseItems_b00_hook, SYM(checkUseItems_b00), b_+OE(73));
  CYC(b_+O(73), b_+OE(76)); A = mem_rd(gb, wLinkPlayingInstrument);
  CYC(b_+O(76), b_+OE(77)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(77), b_+OE(78)); ret_effect(gb); return; } CYC(b_+O(77), b_+OE(78));
  CALL_C(b_+O(78), specialObjectUpdateAdjacentWallsBitset_hook, SYM(specialObjectUpdateAdjacentWallsBitset), b_+OE(81));
  CALL_C(b_+O(81), linkUpdateKnockback_hook, SYM(linkUpdateKnockback), b_+OE(84));
  CYC(b_+O(84), b_+OE(87)); A = mem_rd(gb, wLinkSwimmingState);
  CYC(b_+O(87), b_+OE(88)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(88), b_+OE(91)); linkUpdateSwimming_sidescroll_hook(gb); return; } CYC(b_+O(88), b_+OE(91));
  CYC(b_+O(91), b_+OE(94)); A = mem_rd(gb, wMagnetGloveState);
  CYC(b_+O(94), b_+OE(96)); alu_bit(gb, 6, A);
  if ((F & FZ)) { CYCT(b_+O(96), b_+OE(99)); goto L_5a24; } CYC(b_+O(96), b_+OE(99));
  CYC(b_+O(99), b_+OE(100)); alu_xor(gb, A);
  CYC(b_+O(100), b_+OE(103)); mem_wr(gb, wLinkInAir, A);
  CYC(b_+O(103), b_+OE(106)); TAIL(animateLinkStanding);
L_5a24:
  CALL_C(b_+O(106), linkUpdateInAir_sidescroll_hook, SYM(linkUpdateInAir_sidescroll), b_+OE(109));
  if ((F & FZ)) { CYCT(b_+O(109), b_+OE(110)); ret_effect(gb); return; } CYC(b_+O(109), b_+OE(110));
  CYC(b_+O(110), b_+OE(112)); E = 0x2d;
  CYC(b_+O(112), b_+OE(113)); A = mem_rd(gb, DE);
  CYC(b_+O(113), b_+OE(114)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(114), b_+OE(115)); ret_effect(gb); return; } CYC(b_+O(114), b_+OE(115));
  CYC(b_+O(115), b_+OE(118)); A = mem_rd(gb, wActiveTileIndex);
  CYC(b_+O(118), b_+OE(120)); alu_cp(gb, 0x02);
  if ((F & FZ)) { CALL_C_CC(b_+O(120), dealSpikeDamageToLink_hook, SYM(dealSpikeDamageToLink), b_+OE(123)); } else CYC(b_+O(120), b_+OE(123));
  CYC(b_+O(123), b_+OE(126)); A = mem_rd(gb, wForceIcePhysics);
  CYC(b_+O(126), b_+OE(127)); alu_or(gb, A);
  if ((F & FZ)) { CYCT(b_+O(127), b_+OE(129)); goto L_5a42; } CYC(b_+O(127), b_+OE(129));
  CYC(b_+O(129), b_+OE(131)); E = 0x33;
  CYC(b_+O(131), b_+OE(132)); A = mem_rd(gb, DE);
  CYC(b_+O(132), b_+OE(134)); alu_and(gb, 0x30);
  if (!(F & FZ)) { CYCT(b_+O(134), b_+OE(136)); goto L_5a49; } CYC(b_+O(134), b_+OE(136));
L_5a42:
  CYC(b_+O(136), b_+OE(139)); A = mem_rd(gb, wLastActiveTileType);
  CYC(b_+O(139), b_+OE(141)); alu_cp(gb, 0x40);
  if (!(F & FZ)) { CYCT(b_+O(141), b_+OE(143)); goto L_5a67; } CYC(b_+O(141), b_+OE(143));
L_5a49:
  CYC(b_+O(143), b_+OE(145)); A = 0x21;
  CALL_C(b_+O(145), cpActiveRing_hook, SYM(cpActiveRing), b_+OE(148));
  if ((F & FZ)) { CYCT(b_+O(148), b_+OE(150)); goto L_5a67; } CYC(b_+O(148), b_+OE(150));
  CYC(b_+O(150), b_+OE(152)); C = 0x88;
  CALL_C(b_+O(152), updateLinkSpeed_withParam_hook, SYM(updateLinkSpeed_withParam), b_+OE(155));
  CYC(b_+O(155), b_+OE(157)); A = 0x06;
  CYC(b_+O(157), b_+OE(160)); mem_wr(gb, wForceIcePhysics, A);
  CALL_C(b_+O(160), linkUpdateVelocity_hook, SYM(linkUpdateVelocity), b_+OE(163));
  CYC(b_+O(163), b_+OE(165)); C = 0x02;
  CYC(b_+O(165), b_+OE(168)); A = mem_rd(gb, wLinkAngle);
  CYC(b_+O(168), b_+OE(169)); alu_rlca(gb);
  if ((F & FC)) { CYCT(b_+O(169), b_+OE(171)); goto L_5a82; } CYC(b_+O(169), b_+OE(171));
  CYC(b_+O(171), b_+OE(173)); goto L_5a80;
L_5a67:
  CYC(b_+O(173), b_+OE(174)); alu_xor(gb, A);
  CYC(b_+O(174), b_+OE(177)); mem_wr(gb, wForceIcePhysics, A);
  CYC(b_+O(177), b_+OE(178)); C = A;
  CYC(b_+O(178), b_+OE(181)); A = mem_rd(gb, wLinkAngle);
  CYC(b_+O(181), b_+OE(183)); E = 0x09;
  CYC(b_+O(183), b_+OE(184)); mem_wr(gb, DE, A);
  CYC(b_+O(184), b_+OE(185)); alu_rlca(gb);
  if ((F & FC)) { CYCT(b_+O(185), b_+OE(187)); goto L_5a82; } CYC(b_+O(185), b_+OE(187));
  CALL_C(b_+O(187), updateLinkSpeed_standard_hook, SYM(updateLinkSpeed_standard), b_+OE(190));
  CYC(b_+O(190), b_+OE(192)); C = 0x01;
  CYC(b_+O(192), b_+OE(195)); A = mem_rd(gb, wLinkImmobilized);
  CYC(b_+O(195), b_+OE(196)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(196), b_+OE(198)); goto L_5a82; } CYC(b_+O(196), b_+OE(198));
L_5a80:
  CYC(b_+O(198), b_+OE(200)); C = 0x07;
L_5a82:
  CYC(b_+O(200), b_+OE(203)); SET_HL(wActiveTileType);
  CYC(b_+O(203), b_+OE(204)); A = mem_rd(gb, HL); SET_HL(HL + 1);
  CYC(b_+O(204), b_+OE(205)); alu_or(gb, mem_rd(gb, HL));
  CYC(b_+O(205), b_+OE(207)); alu_and(gb, 0xbf);
  if ((F & FZ)) { CALL_C_CC(b_+O(207), linkAdjustAngleInSidescrollingArea_hook, SYM(linkAdjustAngleInSidescrollingArea), b_+OE(210)); } else CYC(b_+O(207), b_+OE(210));
  CALL_C(b_+O(210), linkUpdateMovement_hook, SYM(linkUpdateMovement), b_+OE(213));
  CYC(b_+O(213), b_+OE(215)); E = 0x09;
  CYC(b_+O(215), b_+OE(216)); A = mem_rd(gb, DE);
  CYC(b_+O(216), b_+OE(218)); alu_add(gb, 0x04);
  CYC(b_+O(218), b_+OE(220)); alu_and(gb, 0x1f);
  CYC(b_+O(220), b_+OE(222)); alu_cp(gb, 0x09);
  if (!(F & FC)) { CYCT(b_+O(222), b_+OE(224)); goto L_5ab5; } CYC(b_+O(222), b_+OE(224));
  CYC(b_+O(224), b_+OE(227)); SET_HL(wActiveTileType);
  CYC(b_+O(227), b_+OE(228)); A = mem_rd(gb, HL); SET_HL(HL + 1);
  CYC(b_+O(228), b_+OE(229)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(229), b_+OE(231)); goto L_5ab5; } CYC(b_+O(229), b_+OE(231));
  CYC(b_+O(231), b_+OE(232)); A = mem_rd(gb, HL);
  CYC(b_+O(232), b_+OE(234)); alu_cp(gb, 0x90);
  if (!(F & FZ)) { CYCT(b_+O(234), b_+OE(236)); goto L_5ab5; } CYC(b_+O(234), b_+OE(236));
  CYC(b_+O(236), b_+OE(238)); E = 0x0b;
  CYC(b_+O(238), b_+OE(239)); A = mem_rd(gb, DE);
  CYC(b_+O(239), b_+OE(241)); alu_and(gb, 0x0f);
  CYC(b_+O(241), b_+OE(243)); alu_cp(gb, 0x09);
  if (!(F & FC)) { CYCT(b_+O(243), b_+OE(245)); goto L_5ab5; } CYC(b_+O(243), b_+OE(245));
  CYC(b_+O(245), b_+OE(246)); A = mem_rd(gb, DE);
  CYC(b_+O(246), b_+OE(248)); alu_and(gb, 0xf0);
  CYC(b_+O(248), b_+OE(250)); alu_add(gb, 0x09);
  CYC(b_+O(250), b_+OE(251)); mem_wr(gb, DE, A);
L_5ab5:
  CYC(b_+O(251), b_+OE(253)); E = 0x33;
  CYC(b_+O(253), b_+OE(254)); A = mem_rd(gb, DE);
  CYC(b_+O(254), b_+OE(256)); alu_and(gb, 0x30);
  if (!(F & FZ)) { CYCT(b_+O(256), b_+OE(258)); goto L_5ac8; } CYC(b_+O(256), b_+OE(258));
  CYC(b_+O(258), b_+OE(261)); A = mem_rd(gb, wActiveTileType);
  CYC(b_+O(261), b_+OE(263)); alu_bit(gb, 4, A);
  if ((F & FZ)) { CYCT(b_+O(263), b_+OE(265)); goto L_5ac8; } CYC(b_+O(263), b_+OE(265));
  CYC(b_+O(265), b_+OE(267)); A = 0x01;
  CYC(b_+O(267), b_+OE(270)); mem_wr(gb, wLinkClimbingVine, A);
L_5ac8:
  CYC(b_+O(270), b_+OE(273)); A = mem_rd(gb, wLinkTurningDisabled);
  CYC(b_+O(273), b_+OE(274)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(274), b_+OE(275)); ret_effect(gb); return; } CYC(b_+O(274), b_+OE(275));
  CYC(b_+O(275), b_+OE(278)); TAIL(updateLinkDirectionFromAngle);
}
...
void linkUpdateInAir_sidescroll_hook(GB *gb) {
  ...
  CYC(b_+O(3), b_+OE(5)); alu_and(gb, 0x0f);
  CYC(b_+O(5), b_+OE(6)); push_effect(gb, b_+OE(6));
  do { uint16_t jt_ = (link_jump_table(gb));
    if (jt_ == b_+O(12)) { goto L_5b9c; }
    else if (jt_ == b_+O(39)) { goto L_5bb7; }
    else if (jt_ == b_+O(65)) { goto L_5bd1; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
L_5b9c:
  CYC(b_+O(12), b_+OE(15)); A = mem_rd(gb, wLinkRidingObject);
  CYC(b_+O(15), b_+OE(16)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(16), b_+OE(17)); ret_effect(gb); return; } CYC(b_+O(16), b_+OE(17));
  CYC(b_+O(17), b_+OE(19)); E = 0x33;
  CYC(b_+O(19), b_+OE(20)); A = mem_rd(gb, DE);
  CYC(b_+O(20), b_+OE(22)); alu_and(gb, 0x30);
  if (!(F & FZ)) { CYCT(b_+O(22), b_+OE(23)); ret_effect(gb); return; } CYC(b_+O(22), b_+OE(23));
  CYC(b_+O(23), b_+OE(26)); SET_HL(wActiveTileType);
  CYC(b_+O(26), b_+OE(27)); A = mem_rd(gb, HL); SET_HL(HL + 1);
  CYC(b_+O(27), b_+OE(28)); alu_or(gb, mem_rd(gb, HL));
  CYC(b_+O(28), b_+OE(30)); alu_bit(gb, 4, A);
  if (!(F & FZ)) { CYCT(b_+O(30), b_+OE(31)); ret_effect(gb); return; } CYC(b_+O(30), b_+OE(31));
  CYC(b_+O(31), b_+OE(32)); H = D;
  CYC(b_+O(32), b_+OE(34)); L = 0x14;
  CYC(b_+O(34), b_+OE(35)); alu_xor(gb, A);
  CYC(b_+O(35), b_+OE(36)); mem_wr(gb, HL, A); SET_HL(HL + 1);
  CYC(b_+O(36), b_+OE(37)); mem_wr(gb, HL, A); SET_HL(HL + 1);
  CYC(b_+O(37), b_+OE(39)); goto L_5bbc;
L_5bb7:
  CYC(b_+O(39), b_+OE(41)); A = 0x53;
  CALL_C(b_+O(41), playSound_b00_hook, SYM(playSound_b00), b_+OE(44));
L_5bbc:
  CYC(b_+O(44), b_+OE(47)); A = mem_rd(gb, wLinkGrabState);
  CYC(b_+O(47), b_+OE(48)); C = A;
  CYC(b_+O(48), b_+OE(51)); A = mem_rd(gb, wLinkTurningDisabled);
  CYC(b_+O(51), b_+OE(52)); alu_or(gb, C);
  CYC(b_+O(52), b_+OE(54)); A = 0x18;
  if ((F & FZ)) { CALL_C_CC(b_+O(54), specialObjectSetAnimation_hook, SYM(specialObjectSetAnimation), b_+OE(57)); } else CYC(b_+O(54), b_+OE(57));
  CYC(b_+O(57), b_+OE(59)); A = 0x02;
  CYC(b_+O(59), b_+OE(62)); mem_wr(gb, wLinkInAir, A);
  CALL_C(b_+O(62), updateLinkSpeed_standard_hook, SYM(updateLinkSpeed_standard), b_+OE(65));
L_5bd1:
  CYC(b_+O(65), b_+OE(66)); H = D;
  CYC(b_+O(66), b_+OE(68)); L = 0x15;
  CYC(b_+O(68), b_+OE(70)); alu_bit(gb, 7, mem_rd(gb, HL));
  if ((F & FZ)) { CYCT(b_+O(70), b_+OE(72)); goto L_5be1; } CYC(b_+O(70), b_+OE(72));
  CYC(b_+O(72), b_+OE(74)); E = 0x33;
  CYC(b_+O(74), b_+OE(75)); A = mem_rd(gb, DE);
  CYC(b_+O(75), b_+OE(77)); alu_and(gb, 0xc0);
  if (!(F & FZ)) { CYCT(b_+O(77), b_+OE(79)); goto L_5c34; } CYC(b_+O(77), b_+OE(79));
  CYC(b_+O(79), b_+OE(81)); goto L_5c29;
L_5be1:
  CYC(b_+O(81), b_+OE(84)); A = mem_rd(gb, wLinkRidingObject);
  CYC(b_+O(84), b_+OE(85)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(85), b_+OE(88)); goto L_5c95; } CYC(b_+O(85), b_+OE(88));
  CYC(b_+O(88), b_+OE(90)); E = 0x33;
  CYC(b_+O(90), b_+OE(91)); A = mem_rd(gb, DE);
  CYC(b_+O(91), b_+OE(93)); alu_and(gb, 0x30);
  if (!(F & FZ)) { CYCT(b_+O(93), b_+OE(96)); goto L_5c72; } CYC(b_+O(93), b_+OE(96));
  CYC(b_+O(96), b_+OE(99)); A = mem_rd(gb, wActiveTileType);
  CYC(b_+O(99), b_+OE(101)); alu_bit(gb, 4, A);
  if ((F & FZ)) { CYCT(b_+O(101), b_+OE(103)); goto L_5bff; } CYC(b_+O(101), b_+OE(103));
  CYC(b_+O(103), b_+OE(106)); A = mem_rd(gb, wGameKeysPressed);
  CYC(b_+O(106), b_+OE(108)); alu_and(gb, 0x40);
  if (!(F & FZ)) { CYCT(b_+O(108), b_+OE(111)); goto L_5c7a; } CYC(b_+O(108), b_+OE(111));
L_5bff:
  CYC(b_+O(111), b_+OE(113)); E = 0x0b;
  CYC(b_+O(113), b_+OE(114)); A = mem_rd(gb, DE);
  CYC(b_+O(114), b_+OE(116)); alu_bit(gb, 3, A);
  if ((F & FZ)) { CYCT(b_+O(116), b_+OE(118)); goto L_5c0d; } CYC(b_+O(116), b_+OE(118));
  CYC(b_+O(118), b_+OE(121)); A = mem_rd(gb, wLastActiveTileType);
  CYC(b_+O(121), b_+OE(123)); alu_cp(gb, 0x90);
  if ((F & FZ)) { CYCT(b_+O(123), b_+OE(125)); goto L_5c72; } CYC(b_+O(123), b_+OE(125));
L_5c0d:
  CYC(b_+O(125), b_+OE(128)); SET_HL(wActiveTileType);
  CYC(b_+O(128), b_+OE(129)); A = mem_rd(gb, HL); SET_HL(HL + 1);
  CYC(b_+O(129), b_+OE(131)); alu_cp(gb, 0x04);
  if ((F & FZ)) { CYCT(b_+O(131), b_+OE(134)); forceDrownLink_hook(gb); return; } CYC(b_+O(131), b_+OE(134));
  CYC(b_+O(134), b_+OE(136)); alu_cp(gb, 0x01);
  if (!(F & FZ)) { CYCT(b_+O(136), b_+OE(138)); goto L_5c26; } CYC(b_+O(136), b_+OE(138));
  CYC(b_+O(138), b_+OE(139)); A = mem_rd(gb, HL);
  CYC(b_+O(139), b_+OE(140)); alu_or(gb, A);
  if (!(F & FZ)) { CYCT(b_+O(140), b_+OE(142)); goto L_5c26; } CYC(b_+O(140), b_+OE(142));
  CYC(b_+O(142), b_+OE(144)); A = 0x5f;
  CALL_C(b_+O(144), playSound_b00_hook, SYM(playSound_b00), b_+OE(147));
  CYC(b_+O(147), b_+OE(150)); TAIL(respawnLink);
L_5c26:
  CALL_C(b_+O(150), linkUpdateVelocity_hook, SYM(linkUpdateVelocity), b_+OE(153));
L_5c29:
  CYC(b_+O(153), b_+OE(155)); L = 0x0a;
  CYC(b_+O(155), b_+OE(157)); E = 0x14;
  CYC(b_+O(157), b_+OE(158)); A = mem_rd(gb, DE);
  CYC(b_+O(158), b_+OE(159)); alu_add(gb, mem_rd(gb, HL));
  CYC(b_+O(159), b_+OE(160)); mem_wr(gb, HL, A); SET_HL(HL + 1);
  CYC(b_+O(160), b_+OE(161)); E = alu_inc8(gb, E);
  CYC(b_+O(161), b_+OE(162)); A = mem_rd(gb, DE);
  CYC(b_+O(162), b_+OE(163)); alu_adc(gb, mem_rd(gb, HL));
  CYC(b_+O(163), b_+OE(164)); mem_wr(gb, HL, A); SET_HL(HL + 1);
L_5c34:
  CYC(b_+O(164), b_+OE(166)); C = 0x24;
  CYC(b_+O(166), b_+OE(169)); A = mem_rd(gb, wLinkInAir);
  CYC(b_+O(169), b_+OE(171)); alu_bit(gb, 5, A);
  if ((F & FZ)) { CYCT(b_+O(171), b_+OE(173)); goto L_5c3f; } CYC(b_+O(171), b_+OE(173));
  CYC(b_+O(173), b_+OE(175)); C = 0x0e;
L_5c3f:
  CYC(b_+O(175), b_+OE(177)); L = 0x14;
  CYC(b_+O(177), b_+OE(178)); A = mem_rd(gb, HL);
  CYC(b_+O(178), b_+OE(179)); alu_add(gb, C);
  CYC(b_+O(179), b_+OE(180)); mem_wr(gb, HL, A); SET_HL(HL + 1);
  CYC(b_+O(180), b_+OE(181)); A = mem_rd(gb, HL);
  CYC(b_+O(181), b_+OE(183)); alu_adc(gb, 0x00);
  CYC(b_+O(183), b_+OE(184)); mem_wr(gb, HL, A); SET_HL(HL - 1);
  CYC(b_+O(184), b_+OE(186)); alu_bit(gb, 7, A);
  if (!(F & FZ)) { CYCT(b_+O(186), b_+OE(188)); goto L_5c54; } CYC(b_+O(186), b_+OE(188));
  CYC(b_+O(188), b_+OE(190)); alu_cp(gb, 0x03);
  if ((F & FC)) { CYCT(b_+O(190), b_+OE(192)); goto L_5c54; } CYC(b_+O(190), b_+OE(192));
  CYC(b_+O(192), b_+OE(193)); alu_xor(gb, A);
  CYC(b_+O(193), b_+OE(194)); mem_wr(gb, HL, A); SET_HL(HL + 1);
  CYC(b_+O(194), b_+OE(196)); mem_wr(gb, HL, 0x03);
L_5c54:
  CALL_C(b_+O(196), specialObjectUpdateAdjacentWallsBitset_hook, SYM(specialObjectUpdateAdjacentWallsBitset), b_+OE(199));
  CYC(b_+O(199), b_+OE(201)); E = 0x33;
  CYC(b_+O(201), b_+OE(202)); A = mem_rd(gb, DE);
  CYC(b_+O(202), b_+OE(204)); alu_and(gb, 0x30);
  if (!(F & FZ)) { CYCT(b_+O(204), b_+OE(206)); goto L_5c72; } CYC(b_+O(204), b_+OE(206));
  CALL_C(b_+O(206), linkAdjustAngleInSidescrollingArea_hook, SYM(linkAdjustAngleInSidescrollingArea), b_+OE(209));
  CALL_C(b_+O(209), specialObjectUpdatePosition_hook, SYM(specialObjectUpdatePosition), b_+OE(212));
  CALL_C(b_+O(212), specialObjectAnimate_hook, SYM(specialObjectAnimate), b_+OE(215));
  CYC(b_+O(215), b_+OE(217)); E = 0x0b;
  CYC(b_+O(217), b_+OE(218)); A = mem_rd(gb, DE);
  CYC(b_+O(218), b_+OE(220)); alu_cp(gb, 0xa9);
  if (game_seasons) {      // Seasons: past the bottom on tile type $10, set the transition direction to $82
    if (F & FC) { CYCT(b_+S(220), b_+S(222)); goto seasons_done; }
    CYC(b_+S(220), b_+S(222));
    CYC(b_+S(222), b_+S(225)); A = W8(wActiveTileType);
    CYC(b_+S(225), b_+S(227)); alu_cp(gb, 0x10);
    if (!(F & FZ)) { CYCT(b_+S(227), b_+S(229)); goto seasons_done; }
    CYC(b_+S(227), b_+S(229));
    CYC(b_+S(229), b_+S(231)); A = 0x82;
    CYC(b_+S(231), b_+S(234)); W8(wScreenTransitionDirection) = A;
seasons_done:
    CYC(b_+S(234), b_+S(235)); alu_xor(gb, A);
    CYC(b_+S(235), b_+S(236)); ret_effect(gb); return;
  }
  if ((F & FC)) { CYCT(b_+O(220), b_+OE(222)); goto L_5c70; } CYC(b_+O(220), b_+OE(222));
  CYC(b_+O(222), b_+OE(224)); goto L_5c72;
L_5c70:
  CYC(b_+O(224), b_+OE(225)); alu_xor(gb, A);
  CYC(b_+O(225), b_+OE(226)); ret_effect(gb); return;
L_5c72:
  CYC(b_+O(226), b_+OE(228)); E = 0x0b;
  CYC(b_+O(228), b_+OE(229)); A = mem_rd(gb, DE);
  CYC(b_+O(229), b_+OE(231)); alu_and(gb, 0xf8);
  CYC(b_+O(231), b_+OE(233)); alu_add(gb, 0x01);
  CYC(b_+O(233), b_+OE(234)); mem_wr(gb, DE, A);
L_5c7a:
  CYC(b_+O(234), b_+OE(235)); alu_xor(gb, A);
  CYC(b_+O(235), b_+OE(237)); E = 0x14;
  CYC(b_+O(237), b_+OE(238)); mem_wr(gb, DE, A);
  CYC(b_+O(238), b_+OE(239)); E = alu_inc8(gb, E);
  CYC(b_+O(239), b_+OE(240)); mem_wr(gb, DE, A);
  CYC(b_+O(240), b_+OE(243)); mem_wr(gb, wLinkInAir, A);
  CYC(b_+O(243), b_+OE(246)); A = mem_rd(gb, wActiveTileIndex);
  CYC(b_+O(246), b_+OE(248)); alu_cp(gb, 0x02);
  if ((F & FZ)) { CALL_C_CC(b_+O(248), dealSpikeDamageToLink_hook, SYM(dealSpikeDamageToLink), b_+OE(251)); } else CYC(b_+O(248), b_+OE(251));
  CYC(b_+O(251), b_+OE(253)); A = 0xa3;
  CALL_C(b_+O(253), playSound_b00_hook, SYM(playSound_b00), b_+OE(256));
  CALL_C(b_+O(256), animateLinkStanding_hook, SYM(animateLinkStanding), b_+OE(259));
  CYC(b_+O(259), b_+OE(260)); alu_xor(gb, A);
  CYC(b_+O(260), b_+OE(261)); ret_effect(gb); return;
L_5c95:
  CYC(b_+O(261), b_+OE(263)); E = 0x12;
  CYC(b_+O(263), b_+OE(264)); alu_xor(gb, A);
  CYC(b_+O(264), b_+OE(265)); mem_wr(gb, DE, A);
  CYC(b_+O(265), b_+OE(267)); A = 0xff;
  CYC(b_+O(267), b_+OE(268)); mem_wr(gb, DE, A);
  CYC(b_+O(268), b_+OE(270)); E = 0x09;
  CYC(b_+O(270), b_+OE(271)); mem_wr(gb, DE, A);
  CYC(b_+O(271), b_+OE(273)); goto L_5c7a;
}

void linkState12_hook(GB *gb) {
  BASE(linkState12);
  uint16_t sp0_ = gb->sp;
  CYC(b_+O(0), b_+OE(2)); E = 0x05;
  CYC(b_+O(2), b_+OE(3)); A = mem_rd(gb, DE);
  CYC(b_+O(3), b_+OE(4)); push_effect(gb, b_+OE(4));
  do { uint16_t jt_ = (link_jump_table(gb));
    if (jt_ == b_+O(12)) { goto L_60b1; }
    else if (jt_ == b_+O(103)) { goto L_610c; }
    else if (jt_ == b_+O(145)) { goto L_6136; }
    else if (jt_ == b_+O(164)) { goto L_6149; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);
L_60b1:
  CALL_C(b_+O(12), itemIncSubstate_hook, SYM(itemIncSubstate), b_+OE(15));
  if (!game_seasons) {
    CYC(b_+15, b_+17); L = 0x2f;
    CYC(b_+17, b_+19); alu_bit(gb, 7, mem_rd(gb, HL));
    if (!(F & FZ)) { CYCT(b_+19, b_+21); goto L_60c7; } CYC(b_+19, b_+21);
  }
  CYC(b_+O(21), b_+OE(24)); A = mem_rd(gb, wLinkGrabState);
  CYC(b_+O(24), b_+OE(25)); C = A;
  CYC(b_+O(25), b_+OE(28)); A = mem_rd(gb, wLinkTurningDisabled);
  CYC(b_+O(28), b_+OE(29)); alu_or(gb, C);
  CYC(b_+O(29), b_+OE(31)); A = 0x18;
  if ((F & FZ)) { CALL_C_CC(b_+O(31), specialObjectSetAnimation_hook, SYM(specialObjectSetAnimation), b_+OE(34)); } else CYC(b_+O(31), b_+OE(34));
L_60c7:
  CYC(b_+O(34), b_+OE(36)); A = 0x53;
  CALL_C(b_+O(36), playSound_b00_hook, SYM(playSound_b00), b_+OE(39));
  CYC(b_+O(39), b_+OE(42)); push_effect(gb, b_+OE(42));
  uint16_t local_sp0 = gb->sp;
  link_state12_get_length_of_cliff_hook(gb);
  if (gb->pc != b_+O(42) || gb->sp != (uint16_t)(local_sp0 + 2)) return;
  if ((F & FZ)) { CYCT(b_+O(42), b_+OE(44)); goto L_60da; } CYC(b_+O(42), b_+OE(44));
  CYC(b_+O(44), b_+OE(47)); SET_HL(b_+O(91));
  CYC(b_+O(47), b_+OE(48)); link_add_a_to_hl(gb, b_+O(48));
  CYC(b_+O(48), b_+OE(49)); A = mem_rd(gb, HL);
  CYC(b_+O(49), b_+OE(51)); E = 0x10;
  CYC(b_+O(51), b_+OE(52)); mem_wr(gb, DE, A);
  CYC(b_+O(52), b_+OE(53)); ret_effect(gb); return;
L_60da:
  CYC(b_+O(53), b_+OE(56)); A = mem_rd(gb, wScreenTransitionBoundaryY);
  CYC(b_+O(56), b_+OE(57)); B = A;
  CYC(b_+O(57), b_+OE(58)); H = D;
  CYC(b_+O(58), b_+OE(60)); L = 0x0b;
  CYC(b_+O(60), b_+OE(61)); A = mem_rd(gb, HL);
  CYC(b_+O(61), b_+OE(62)); alu_sub(gb, B);
  CYC(b_+O(62), b_+OE(63)); mem_wr(gb, HL, B);
  CYC(b_+O(63), b_+OE(65)); L = 0x0f;
  CYC(b_+O(65), b_+OE(66)); mem_wr(gb, HL, A);
  CYC(b_+O(66), b_+OE(68)); L = 0x1a;
  CYC(b_+O(68), b_+OE(70)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) & ~(1 << 6)));
  CYC(b_+O(70), b_+OE(72)); L = 0x05;
  CYC(b_+O(72), b_+OE(74)); mem_wr(gb, HL, 0x02);
  CYC(b_+O(74), b_+OE(75)); alu_xor(gb, A);
  CYC(b_+O(75), b_+OE(77)); L = 0x10;
  CYC(b_+O(77), b_+OE(78)); mem_wr(gb, HL, A);
  CYC(b_+O(78), b_+OE(80)); L = 0x14;
  CYC(b_+O(80), b_+OE(81)); mem_wr(gb, HL, A); SET_HL(HL + 1);
  CYC(b_+O(81), b_+OE(83)); mem_wr(gb, HL, 0xff);
  CYC(b_+O(83), b_+OE(84)); A = alu_inc8(gb, A);
  CYC(b_+O(84), b_+OE(87)); mem_wr(gb, wDisableScreenTransitions, A);
  CYC(b_+O(87), b_+OE(89)); L = 0x2f;
  CYC(b_+O(89), b_+OE(91)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) | (1 << 0)));
  CYC(b_+O(91), b_+OE(92)); ret_effect(gb); return;
L_610c:
  CALL_C(b_+O(103), objectApplySpeed_hook, SYM(objectApplySpeed), b_+OE(106));
  CYC(b_+O(106), b_+OE(108)); C = 0x20;
  CALL_C(b_+O(108), objectUpdateSpeedZ_paramC_hook, SYM(objectUpdateSpeedZ_paramC), b_+OE(111));
  if (!(F & FZ)) { CYCT(b_+O(111), b_+OE(114)); specialObjectAnimate_hook(gb); return; } CYC(b_+O(111), b_+OE(114));
  CYC(b_+O(114), b_+OE(115)); H = D;
  CYC(b_+O(115), b_+OE(117)); L = 0x2f;
  CYC(b_+O(117), b_+OE(119)); alu_bit(gb, 0, mem_rd(gb, HL));
  CYC(b_+O(119), b_+OE(121)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) & ~(1 << 0)));
  if (!(F & FZ)) { CALL_C_CC(b_+O(121), updateLinkLocalRespawnPosition_hook, SYM(updateLinkLocalRespawnPosition), b_+OE(124)); } else CYC(b_+O(121), b_+OE(124));
  CALL_C(b_+O(124), specialObjectTryToBreakTile_source05_hook, SYM(specialObjectTryToBreakTile_source05), b_+OE(127));
  if (game_seasons) {
    CYC(b_+S(121), b_+S(124)); A = W8(wActiveGroup);
    CYC(b_+S(124), b_+S(125)); alu_or(gb, A);
    if (!(F & FZ)) CYCT(b_+S(125), b_+S(127));
    else {
      CYC(b_+S(125), b_+S(127));
      CYC(b_+S(127), b_+S(130)); SET_BC(0x0500);
      CALL_C(b_+S(130), objectGetRelativeTile_hook, SYM(objectGetRelativeTile), b_+S(133));
      CYC(b_+S(133), b_+S(135)); alu_cp(gb, 0x20);
      if (!(F & FZ)) CYCT(b_+S(135), b_+S(137));
      else {
        CYC(b_+S(135), b_+S(137));
        CALL_C(b_+S(137), objectCenterOnTile_hook, SYM(objectCenterOnTile), b_+S(140));
        CYC(b_+S(140), b_+S(142)); L = 0x0b;
        CYC(b_+S(142), b_+S(143)); A = mem_rd(gb, HL);
        CYC(b_+S(143), b_+S(145)); alu_sub(gb, 0x06);
        CYC(b_+S(145), b_+S(146)); mem_wr(gb, HL, A);
      }
    }
  }
  CYC(b_+O(127), b_+OE(128)); alu_xor(gb, A);
  CYC(b_+O(128), b_+OE(131)); mem_wr(gb, wLinkInAir, A);
  CYC(b_+O(131), b_+OE(134)); mem_wr(gb, wLinkSwimmingState, A);
  CYC(b_+O(134), b_+OE(136)); A = 0xa3;
  CALL_C(b_+O(136), playSound_b00_hook, SYM(playSound_b00), b_+OE(139));
  CALL_C(b_+O(139), specialObjectUpdateAdjacentWallsBitset_hook, SYM(specialObjectUpdateAdjacentWallsBitset), b_+OE(142));
  CYC(b_+O(142), b_+OE(145)); TAIL(initLinkStateAndAnimateStanding);
L_6136:
  CYC(b_+O(145), b_+OE(147)); C = 0x20;
  CALL_C(b_+O(147), objectUpdateSpeedZ_paramC_hook, SYM(objectUpdateSpeedZ_paramC), b_+OE(150));
  if (!(F & FZ)) { CYCT(b_+O(150), b_+OE(153)); specialObjectAnimate_hook(gb); return; } CYC(b_+O(150), b_+OE(153));
  CYC(b_+O(153), b_+OE(155)); A = 0x82;
  CYC(b_+O(155), b_+OE(158)); mem_wr(gb, wScreenTransitionDirection, A);
  CYC(b_+O(158), b_+OE(160)); E = 0x05;
  CYC(b_+O(160), b_+OE(162)); A = 0x03;
  CYC(b_+O(162), b_+OE(163)); mem_wr(gb, DE, A);
  CYC(b_+O(163), b_+OE(164)); ret_effect(gb); return;
L_6149:
  CYC(b_+O(164), b_+OE(167)); A = mem_rd(gb, wScreenVariables);
  CYC(b_+O(167), b_+OE(169)); alu_cp(gb, 0x01);
  if (!(F & FZ)) { CYCT(b_+O(169), b_+OE(170)); ret_effect(gb); return; } CYC(b_+O(169), b_+OE(170));
  CYC(b_+O(170), b_+OE(173)); push_effect(gb, b_+OE(173));
  uint16_t local_sp1 = gb->sp;
  link_state12_get_length_of_cliff_hook(gb);
  if (gb->pc != b_+O(173) || gb->sp != (uint16_t)(local_sp1 + 2)) return;
  CYC(b_+O(173), b_+OE(174)); H = D;
  CYC(b_+O(174), b_+OE(176)); L = 0x0b;
  CYC(b_+O(176), b_+OE(177)); A = mem_rd(gb, HL);
  CYC(b_+O(177), b_+OE(178)); alu_sub(gb, B);
  CYC(b_+O(178), b_+OE(179)); mem_wr(gb, HL, B);
  CYC(b_+O(179), b_+OE(181)); L = 0x0f;
  CYC(b_+O(181), b_+OE(182)); mem_wr(gb, HL, A);
  CYC(b_+O(182), b_+OE(184)); L = 0x1a;
  CYC(b_+O(184), b_+OE(186)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) | (1 << 6)));
  CYC(b_+O(186), b_+OE(188)); L = 0x05;
  CYC(b_+O(188), b_+OE(190)); mem_wr(gb, HL, 0x01);
  CYC(b_+O(190), b_+OE(191)); ret_effect(gb); return;
}

void link_state12_get_length_of_cliff_hook(GB *gb) {
  BASE(linkState12);
  uint16_t sp0_ = gb->sp;
  CYC(b_+O(191), b_+OE(192)); H = D;
  CYC(b_+O(192), b_+OE(194)); L = 0x0b;
  CYC(b_+O(194), b_+OE(195)); A = mem_rd(gb, HL); SET_HL(HL + 1);
  CYC(b_+O(195), b_+OE(197)); alu_add(gb, 0x05);
  CYC(b_+O(197), b_+OE(198)); B = A;
  CYC(b_+O(198), b_+OE(199)); L = alu_inc8(gb, L);
  CYC(b_+O(199), b_+OE(200)); C = mem_rd(gb, HL);
  CYC(b_+O(200), b_+OE(202)); L = 0x09;
  CYC(b_+O(202), b_+OE(203)); A = mem_rd(gb, HL);
  CYC(b_+O(203), b_+OE(204)); alu_add(gb, A);
  CYC(b_+O(204), b_+OE(206)); A = alu_swap(gb, A);
  CYC(b_+O(206), b_+OE(208)); alu_and(gb, 0x03);
  CYC(b_+O(208), b_+OE(211)); SET_HL(b_+O(274));
  CYC(b_+O(211), b_+OE(212)); link_add_double_index(gb, b_+O(212));
  CYC(b_+O(212), b_+OE(213)); A = mem_rd(gb, HL); SET_HL(HL + 1);
  CYC(b_+O(213), b_+OE(215)); H8(hFF8D) = A;
  CYC(b_+O(215), b_+OE(216)); A = mem_rd(gb, HL);
  CYC(b_+O(216), b_+OE(218)); H8(hFF8C) = A;
  CYC(b_+O(218), b_+OE(220)); A = 0x01;
  CYC(b_+O(220), b_+OE(222)); H8(hFF8B) = A;
L_6183:
  CYC(b_+O(222), b_+OE(224)); A = H8(hFF8D);
  CYC(b_+O(224), b_+OE(225)); alu_add(gb, B);
  CYC(b_+O(225), b_+OE(226)); B = A;
  CYC(b_+O(226), b_+OE(228)); A = H8(hFF8C);
  CYC(b_+O(228), b_+OE(229)); alu_add(gb, C);
  CYC(b_+O(229), b_+OE(230)); C = A;
  CALL_C(b_+O(230), checkTileCollisionAt_allowHoles_hook, SYM(checkTileCollisionAt_allowHoles), b_+OE(233));
  if (!(F & FC)) { CYCT(b_+O(233), b_+OE(235)); goto L_61a8; } CYC(b_+O(233), b_+OE(235));
  CYC(b_+O(235), b_+OE(237)); A = 0x85;
  CALL_C(b_+O(237), tryToBreakTile_hook, SYM(tryToBreakTile), b_+OE(240));
  if ((F & FC)) { CYCT(b_+O(240), b_+OE(242)); goto L_61ad; } CYC(b_+O(240), b_+OE(242));
  CYC(b_+O(242), b_+OE(244)); A = H8(hFF92);
  CYC(b_+O(244), b_+OE(247)); SET_HL(SYM(landableTileFromCliffExceptions));
  CALL_C(b_+O(247), findByteInCollisionTable_hook, SYM(findByteInCollisionTable), b_+OE(250));
  if ((F & FC)) { CYCT(b_+O(250), b_+OE(252)); goto L_61ad; } CYC(b_+O(250), b_+OE(252));
  CYC(b_+O(252), b_+OE(254)); A = H8(hFF8B);
  CYC(b_+O(254), b_+OE(255)); A = alu_inc8(gb, A);
  CYC(b_+O(255), b_+OE(257)); H8(hFF8B) = A;
  CYC(b_+O(257), b_+OE(259)); goto L_6183;
L_61a8:
  CALL_C(b_+O(259), getTileAtPosition_hook, SYM(getTileAtPosition), b_+OE(262));
  CYC(b_+O(262), b_+OE(263)); alu_or(gb, A);
  if ((F & FZ)) { CYCT(b_+O(263), b_+OE(264)); ret_effect(gb); return; } CYC(b_+O(263), b_+OE(264));
L_61ad:
  CYC(b_+O(264), b_+OE(266)); A = H8(hFF8B);
  CYC(b_+O(266), b_+OE(268)); alu_cp(gb, 0x0b);
  if ((F & FC)) { CYCT(b_+O(268), b_+OE(270)); goto L_61b5; } CYC(b_+O(268), b_+OE(270));
  CYC(b_+O(270), b_+OE(272)); A = 0x0b;
L_61b5:
  CYC(b_+O(272), b_+OE(273)); alu_or(gb, A);
  CYC(b_+O(273), b_+OE(274)); ret_effect(gb); return;
}
...
void warpTransition5_01_hook(GB *gb) {
  ...
  uint16_t sp0_ = gb->sp;
  CALL_C(b_+O(0), specialObjectAnimate_hook, SYM(specialObjectAnimate), b_+OE(3));
  CYC(b_+O(3), b_+OE(5)); C = 0x20;
  ...
  CYC(b_+O(8), b_+OE(9));
  if (game_seasons) {
    CALL_C(b_+S(9), objectGetTileAtPosition_hook, SYM(objectGetTileAtPosition), b_+S(12));
    CYC(b_+S(12), b_+S(14)); alu_cp(gb, 0x07);
    if (F & FZ) {
      CYCT(b_+S(14), b_+S(16));
      CYC(b_+S(28), b_+S(31)); A = W8(wActiveGroup);
      CYC(b_+S(31), b_+S(33)); alu_and(gb, 0x06);
      CYC(b_+S(33), b_+S(35)); alu_cp(gb, 0x04);
      if (!(F & FZ)) {
        CYCT(b_+S(35), b_+S(38));
        warp_transition7_link_collapsed(gb, sp0_);
        return;
      }
      CYC(b_+S(35), b_+S(38));
      CYC(b_+S(38), b_+S(41)); TAIL_S(bounceLinkOffTrampolineAfterFalling);
    }
    CYC(b_+S(14), b_+S(16));
  }
  CYC(b_+O(9), b_+OE(12)); SET_HL(SYM(hazardCollisionTable));
  CALL_C(b_+O(12), lookupCollisionTable_hook, SYM(lookupCollisionTable), b_+OE(15));
  if (!(F & FC)) {
    CYCT(b_+O(15), b_+OE(18));
    warp_transition7_link_collapsed(gb, sp0_);
    return;
  }
...
void warpTransitionB_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (link_jump_table(gb));
    ...
    else if (jt_ == b_+O(28)) { goto state1; }
    else if (jt_ == b_+O(48)) { goto state2; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);

state0:
  CALL_C(b_+O(10), itemIncSubstate_hook, SYM(itemIncSubstate), b_+OE(13));
  CALL_C(b_+O(13), objectGetZAboveScreen_hook, SYM(objectGetZAboveScreen), b_+OE(16));
  CYC(b_+O(16), b_+OE(18)); L = 0x0f;
  CYC(b_+O(18), b_+OE(19)); mem_wr(gb, HL, A);
  CYC(b_+O(19), b_+OE(21)); L = 0x08;
  CYC(b_+O(21), b_+OE(23)); mem_wr(gb, HL, 0x02);
  CYC(b_+O(23), b_+OE(25)); A = 0x04;
  CYC(b_+O(25), b_+OE(28));
  TAIL(specialObjectSetAnimation);

state1:
  CALL_C(b_+O(28), specialObjectAnimate_hook, SYM(specialObjectAnimate), b_+OE(31));
  CYC(b_+O(31), b_+OE(33)); C = 0x0c;
  CALL_C(b_+O(33), objectUpdateSpeedZ_paramC_hook, SYM(objectUpdateSpeedZ_paramC), b_+OE(36));
  if (!(F & FZ)) { CYCT(b_+O(36), b_+OE(37)); ret_effect(gb); return; }
  CYC(b_+O(36), b_+OE(37));
  if (game_seasons) {
    CYC(b_+S(37), b_+S(38)); alu_xor(gb, A);
    CYC(b_+S(38), b_+S(41)); W8(wDisabledObjects) = A;
    CYC(b_+S(41), b_+S(43)); A = 0x08;
    CALL_C(b_+S(43), setLinkIDOverride_hook, SYM(setLinkIDOverride), b_+S(46));
    CYC(b_+S(46), b_+S(48)); L = 0x02;
    CYC(b_+S(48), b_+S(50)); mem_wr(gb, HL, 0x02);
    CYC(b_+S(50), b_+S(51)); ret_effect(gb);
    return;
  } else {
...
state2:
  CYC(b_+O(48), b_+OE(51)); A = W8(wDisabledObjects);
  CYC(b_+O(51), b_+OE(53)); alu_and(gb, 0x81);
  if (!(F & FZ)) { CYCT(b_+O(53), b_+OE(54)); ret_effect(gb); return; }
  CYC(b_+O(53), b_+OE(54));
  CALL_C(b_+O(54), objectSetVisiblec2_hook, SYM(objectSetVisiblec2), b_+OE(57));
  CYC(b_+O(57), b_+OE(60));
  TAIL(initLinkStateAndAnimateStanding);
}
...
void linkState02_hook(GB *gb) {
  BASE(linkState02);
  uint16_t sp0_ = gb->sp;
  CYC(b_+O(0), b_+OE(2)); A = 0xff;
  CYC(b_+O(2), b_+OE(5)); W8(wGameKeysPressed) = A;
  CYC(b_+O(5), b_+OE(7)); A = 0x80;
  CYC(b_+O(7), b_+OE(10)); W8(wForceLinkPushAnimation) = A;
  CYC(b_+O(10), b_+OE(12)); E = 0x05;
  CYC(b_+O(12), b_+OE(13)); A = mem_rd(gb, DE);
  CYC(b_+O(13), b_+OE(14)); push_effect(gb, b_+OE(14));
  do { uint16_t jt_ = (link_jump_table(gb));
    if (jt_ == b_+O(26)) { goto substate0; }
    else if (jt_ == b_+O(81)) { goto substate1; }
    else if (jt_ == b_+O(148)) { goto substate2; }
    else if (jt_ == b_+O(207)) { goto substate3; }
    else if (jt_ == b_+O(218)) { goto substate4; }
    else if (jt_ == b_+O(232)) { goto substate5; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);

substate0:
  CALL_C(b_+O(26), linkCancelAllItemUsage_hook, SYM(linkCancelAllItemUsage), b_+OE(29));
  CYC(b_+O(29), b_+OE(32)); A = W8(wLinkStateParameter);
  CYC(b_+O(32), b_+OE(33)); push_effect(gb, b_+OE(33));
  do { uint16_t jt_ = (link_jump_table(gb));
    if (jt_ == b_+O(53)) { goto parameter_fall_down_hole; }
    else if (jt_ == b_+O(56)) { goto parameter_fall_without_centering; }
    else if (jt_ == b_+O(126)) { goto respawn; }
    else if (jt_ == b_+O(61)) { goto parameter_3; }
    else if (jt_ == b_+O(43)) { goto parameter_drown; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);

parameter_drown:
  CYC(b_+O(43), b_+OE(45)); E = 0x05;
  CYC(b_+O(45), b_+OE(47)); A = 0x05;
  CYC(b_+O(47), b_+OE(48)); mem_wr(gb, DE, A);
  CYC(b_+O(48), b_+OE(50)); A = 0x0a;
  CYC(b_+O(50), b_+OE(53));
  TAIL(specialObjectSetAnimation);

parameter_fall_down_hole:
  CALL_C(b_+O(53), objectCenterOnTile_hook, SYM(objectCenterOnTile), b_+OE(56));

parameter_fall_without_centering:
  CALL_C(b_+O(56), itemIncSubstate_hook, SYM(itemIncSubstate), b_+OE(59));
  CYC(b_+O(59), b_+OE(61));
  goto start_falling;

parameter_3:
  CYC(b_+O(61), b_+OE(63)); E = 0x05;
  CYC(b_+O(63), b_+OE(65)); A = 0x04;
  CYC(b_+O(65), b_+OE(66)); mem_wr(gb, DE, A);

start_falling:
  CYC(b_+O(66), b_+OE(67)); H = D;
  CYC(b_+O(67), b_+OE(69)); L = 0x24;
  CYC(b_+O(69), b_+OE(71)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) & ~(1 << 7)));
  CYC(b_+O(71), b_+OE(73)); A = 0x0d;
  CALL_C(b_+O(73), specialObjectSetAnimation_hook, SYM(specialObjectSetAnimation), b_+OE(76));
  CYC(b_+O(76), b_+OE(78)); A = 0x65;
  CYC(b_+O(78), b_+OE(81));
  TAIL(playSound_b00);

substate1:
  CYC(b_+O(81), b_+OE(82)); H = D;
  CYC(b_+O(82), b_+OE(84)); L = 0x21;
  CYC(b_+O(84), b_+OE(86)); alu_bit(gb, 7, mem_rd(gb, HL));
  if (F & FZ) {
    CYCT(b_+O(86), b_+OE(89));
    TAIL(specialObjectAnimate);
  }
  CYC(b_+O(86), b_+OE(89));
  CYC(b_+O(89), b_+OE(92)); A = W8(wActiveTileType);
  CYC(b_+O(92), b_+OE(94)); alu_cp(gb, 0x02);
  if (!(F & FZ)) { CYCT(b_+O(94), b_+OE(96)); goto respawn; }
  CYC(b_+O(94), b_+OE(96));
  if (game_seasons) {
    CYC(b_+S(96), b_+S(99)); A = W8(wDungeonIndex);
    CYC(b_+S(99), b_+S(101)); alu_cp(gb, 0x09);
    if (!(F & FZ)) { CYCT(b_+S(101), b_+S(103)); goto ordinary_hole_warp; }
    CYC(b_+S(101), b_+S(103));
    CYC(b_+S(103), b_+S(105)); A = 0x13;
    CYC(b_+S(105), b_+S(108)); W8(wCutsceneTrigger) = A;
    CYC(b_+S(108), b_+S(109)); ret_effect(gb);
    return;
  } else {
...
ordinary_hole_warp:
  CYC(b_+O(118), b_+OE(121)); SET_HL(SYM(initiateFallDownHoleWarp));
  CYC(b_+O(121), b_+OE(123)); E = 0x01;
  CYC(b_+O(123), b_+OE(126));
  TAIL(interBankCall);

respawn:
  CALL_C(b_+O(126), specialObjectSetCoordinatesToRespawnYX_hook, SYM(specialObjectSetCoordinatesToRespawnYX), b_+OE(129));
  CYC(b_+O(129), b_+OE(131)); L = 0x05;
  CYC(b_+O(131), b_+OE(133)); A = 0x02;
  CYC(b_+O(133), b_+OE(134)); mem_wr(gb, HL, A); SET_HL(HL + 1);
  CYC(b_+O(134), b_+OE(135)); mem_wr(gb, HL, A);
  CALL_C(b_+O(135), specialObjectTryToBreakTile_source05_hook, SYM(specialObjectTryToBreakTile_source05), b_+OE(138));
  CALL_C(b_+O(138), objectGetTileAtPosition_hook, SYM(objectGetTileAtPosition), b_+OE(141));
  CYC(b_+O(141), b_+OE(142)); A = L;
  CYC(b_+O(142), b_+OE(145)); W8(wEnteredWarpPosition) = A;
  CYC(b_+O(145), b_+OE(148));
  TAIL(objectSetInvisible);

substate2:
  CYC(b_+O(148), b_+OE(149)); H = D;
  CYC(b_+O(149), b_+OE(151)); L = 0x06;
  CYC(b_+O(151), b_+OE(154)); A = W8(wScrollMode);
  CYC(b_+O(154), b_+OE(156)); alu_and(gb, 0x80);
  if (!(F & FZ)) {
    CYC(b_+O(156), b_+OE(158));
    CYC(b_+O(158), b_+OE(160)); mem_wr(gb, HL, 0x04);
    CYC(b_+O(160), b_+OE(161)); ret_effect(gb);
    return;
  }
  CYCT(b_+O(156), b_+OE(158));
  CYC(b_+O(161), b_+OE(162)); mem_wr(gb, HL, alu_dec8(gb, mem_rd(gb, HL)));
  if (!(F & FZ)) { CYCT(b_+O(162), b_+OE(163)); ret_effect(gb); return; }
  CYC(b_+O(162), b_+OE(163));
  CYC(b_+O(163), b_+OE(164)); alu_xor(gb, A);
  CYC(b_+O(164), b_+OE(167)); W8(wLinkInAir) = A;
  CYC(b_+O(167), b_+OE(170)); W8(wLinkSwimmingState) = A;
  CYC(b_+O(170), b_+OE(172)); A = 0x1c;
  CALL_C(b_+O(172), cpActiveRing_hook, SYM(cpActiveRing), b_+OE(175));
  CYC(b_+O(175), b_+OE(177)); A = 0xfc;
  if (!(F & FZ)) {
    CYCT(b_+O(177), b_+OE(179));
  } else {
    CYC(b_+O(177), b_+OE(179));
    CYC(b_+O(179), b_+OE(181)); A = alu_sra(gb, A);
  }
  CALL_C(b_+O(181), itemIncSubstate_hook, SYM(itemIncSubstate), b_+OE(184));
  CYC(b_+O(184), b_+OE(186)); L = 0x25;
  CYC(b_+O(186), b_+OE(187)); mem_wr(gb, HL, A);
  CYC(b_+O(187), b_+OE(189)); L = 0x2b;
  CYC(b_+O(189), b_+OE(191)); mem_wr(gb, HL, 0x3c);
  CYC(b_+O(191), b_+OE(193)); L = 0x06;
  CYC(b_+O(193), b_+OE(195)); mem_wr(gb, HL, 0x10);
  CALL_C(b_+O(195), linkApplyDamage_b00_hook, SYM(linkApplyDamage_b00), b_+OE(198));
  CALL_C(b_+O(198), objectSetVisiblec1_hook, SYM(objectSetVisiblec1), b_+OE(201));
  CALL_C(b_+O(201), specialObjectUpdateAdjacentWallsBitset_hook, SYM(specialObjectUpdateAdjacentWallsBitset), b_+OE(204));
  CYC(b_+O(204), b_+OE(207));
  TAIL(animateLinkStanding);

substate3:
  CALL_C(b_+O(207), itemDecCounter1_hook, SYM(itemDecCounter1), b_+OE(210));
  if (!(F & FZ)) { CYCT(b_+O(210), b_+OE(211)); ret_effect(gb); return; }
  CYC(b_+O(210), b_+OE(211));
  CYC(b_+O(211), b_+OE(213)); L = 0x24;
  CYC(b_+O(213), b_+OE(215)); mem_wr(gb, HL, (uint8_t)(mem_rd(gb, HL) | (1 << 7)));
  CYC(b_+O(215), b_+OE(218));
  TAIL(initLinkStateAndAnimateStanding);

substate4:
  CYC(b_+O(218), b_+OE(219)); H = D;
  CYC(b_+O(219), b_+OE(221)); L = 0x21;
  CYC(b_+O(221), b_+OE(223)); alu_bit(gb, 7, mem_rd(gb, HL));
  if (F & FZ) {
    CYCT(b_+O(223), b_+OE(226));
    TAIL(specialObjectAnimate);
  }
  CYC(b_+O(223), b_+OE(226));
  CALL_C(b_+O(226), objectSetInvisible_hook, SYM(objectSetInvisible), b_+OE(229));
  CYC(b_+O(229), b_+OE(232));
  TAIL(checkLinkForceState);

substate5:
  CYC(b_+O(232), b_+OE(234)); E = 0x21;
  CYC(b_+O(234), b_+OE(235)); A = mem_rd(gb, DE);
  CYC(b_+O(235), b_+OE(236)); alu_rlca(gb);
  if (!(F & FC)) {
    CYCT(b_+O(236), b_+OE(239));
    TAIL(specialObjectAnimate);
  }
  CYC(b_+O(236), b_+OE(239));
  CYC(b_+O(239), b_+OE(241));
  goto respawn;
}
...
void linkState0d_hook(GB *gb) {
  ...
  uint16_t sp0_ = gb->sp;
  CYC(b_+O(0), b_+OE(2)); A = 0x80;
  CYC(b_+O(2), b_+OE(5)); W8(wcc92) = A;
  CYC(b_+O(5), b_+OE(7)); E = 0x05;
  CYC(b_+O(7), b_+OE(8)); A = mem_rd(gb, DE);
  CYC(b_+O(8), b_+OE(9)); push_effect(gb, b_+OE(9));
  do { uint16_t jt_ = (link_jump_table(gb));
    if (jt_ == b_+O(19)) { goto substate0; }
    ...
    else if (jt_ == b_+O(32)) { goto substate2; }
    else if (jt_ == b_+O(62)) { goto substate3; }
    else if (jt_ == b_+O(81)) { goto substate4; }
    else { hook_continue(gb, HL, sp0_); return; }
  } while (0);

substate0:
  CYC(b_+O(19), b_+OE(21)); A = 0x01;
  CYC(b_+O(21), b_+OE(22)); mem_wr(gb, DE, A);
  CYC(b_+O(22), b_+OE(25)); W8(wWarpsDisabled) = A;
  CYC(b_+O(25), b_+OE(27)); E = 0x30;
  CYC(b_+O(27), b_+OE(28)); alu_xor(gb, A);
  CYC(b_+O(28), b_+OE(29)); mem_wr(gb, DE, A);
  CYC(b_+O(29), b_+OE(32));
  TAIL(linkCancelAllItemUsage);

substate2:
  CYC(b_+O(32), b_+OE(34)); A = 0x03;
  CYC(b_+O(34), b_+OE(35)); mem_wr(gb, DE, A);
  CYC(b_+O(35), b_+OE(36)); H = D;
  CYC(b_+O(36), b_+OE(38)); L = 0x06;
  CYC(b_+O(38), b_+OE(40)); mem_wr(gb, HL, 0x1e);
  if (game_seasons) {
    CYC(b_+S(40), b_+S(42)); A = 0xe8;
    CYC(b_+S(42), b_+S(44)); L = 0x0f;
    CYC(b_+S(44), b_+S(45)); mem_wr(gb, HL, A);
    CYC(b_+S(45), b_+S(47)); L = 0x0b;
    CYC(b_+S(47), b_+S(48)); alu_cpl(gb);
    CYC(b_+S(48), b_+S(49)); A = alu_inc8(gb, A);
    CYC(b_+S(49), b_+S(50)); alu_add(gb, mem_rd(gb, HL));
    CYC(b_+S(50), b_+S(51)); mem_wr(gb, HL, A);
    CYC(b_+S(51), b_+S(52)); alu_xor(gb, A);
    CYC(b_+S(52), b_+S(54)); L = 0x14;
    CYC(b_+S(54), b_+S(55)); mem_wr(gb, HL, A); SET_HL(HL + 1);
    CYC(b_+S(55), b_+S(56)); mem_wr(gb, HL, A); SET_HL(HL + 1);
    CYC(b_+S(56), b_+S(58)); L = 0x08;
    CYC(b_+S(58), b_+S(59)); mem_wr(gb, HL, A); SET_HL(HL + 1);
    CYC(b_+S(59), b_+S(61)); mem_wr(gb, HL, 0x0c);
  } else {
  ...
  CYC(b_+O(53), b_+OE(55)); L = 0x10;
  CYC(b_+O(55), b_+OE(57)); mem_wr(gb, HL, 0x3c);
  CYC(b_+O(57), b_+OE(59)); A = 0x03;
  CYC(b_+O(59), b_+OE(62));
  TAIL(specialObjectSetAnimation);

substate3:
  CALL_C(b_+O(62), itemDecCounter1_hook, SYM(itemDecCounter1), b_+OE(65));
  if (F & FZ) { CYCT(b_+O(65), b_+OE(67)); goto restore_normal; }
  CYC(b_+O(65), b_+OE(67));
  CYC(b_+O(67), b_+OE(69)); C = 0x20;
  CALL_C(b_+O(69), objectUpdateSpeedZ_paramC_hook, SYM(objectUpdateSpeedZ_paramC), b_+OE(72));
  CALL_C(b_+O(72), specialObjectUpdateAdjacentWallsBitset_hook, SYM(specialObjectUpdateAdjacentWallsBitset), b_+OE(75));
  CALL_C(b_+O(75), specialObjectUpdatePosition_hook, SYM(specialObjectUpdatePosition), b_+OE(78));
  CYC(b_+O(78), b_+OE(81));
  TAIL(specialObjectAnimate);

substate4:
  CYC(b_+O(81), b_+OE(82)); H = D;
  CYC(b_+O(82), b_+OE(84)); L = 0x2b;
  CYC(b_+O(84), b_+OE(86)); mem_wr(gb, HL, 0x94);

restore_normal:
  CYC(b_+O(86), b_+OE(87)); alu_xor(gb, A);
  CYC(b_+O(87), b_+OE(90)); W8(wWarpsDisabled) = A;
  CYC(b_+O(90), b_+OE(93));
  TAIL(initLinkStateAndAnimateStanding);
}
