...
void fileManagementFunction_hook(GB *gb) {
  ...
  do { uint16_t jt_ = (jump_table_from_rst(gb));
    if (jt_ == SYM(initializeFile_b07) && hook_is(gb, SYM(initializeFile_b07), initializeFile_b07_hook)) { initializeFile_b07_hook(gb); return; }
    else if (jt_ == SYM(saveFile_b07) && hook_is(gb, SYM(saveFile_b07), saveFile_b07_hook)) { saveFile_b07_hook(gb); return; }
    else if (jt_ == SYM(loadFile_b07) && hook_is(gb, SYM(loadFile_b07), loadFile_b07_hook)) { loadFile_b07_hook(gb); return; }
    else if (jt_ == SYM(eraseFile_b07) && hook_is(gb, SYM(eraseFile_b07), eraseFile_b07_hook)) { eraseFile_b07_hook(gb); return; }
