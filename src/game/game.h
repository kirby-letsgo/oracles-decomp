...
#define ROM_add16BitRefs 0x23a7
#define ROM_checkTileCollisionAt_allowHoles 0x14d1
#define ROM_objectUpdateSpeedZAndBounce 0x2370
#define ROM_getRandomNumber_noPreserveVars 0x0453
#define ROM_updateInteractionsAndDrawAllSprites 0x351e
#define ROM_b06_interactWithTileBeforeLink 0x4000
#define ROM_b3f_reloadObjectGfx 0x4125
#define ROM_b3f_loadWeaponGfx 0x445b
#define ROM_b3f_loadTreasureDisplayData 0x46f8
#define ROM_b3f_checkTreasureObtained_body 0x446d
#define ROM_b3f_enemyLoadGraphicsAndProperties 0x4368
#define ROM_b01_makeActiveObjectFollowLink 0x4910
#define ROM_b05_linkApplyDamage_b5 0x4270
#define ROM_b06_specialObjectCode_companionCutscene 0x6cec
#define ROM_b06_specialObjectCode_linkInCutscene 0x70a0
#define ROM_b12_parseGivenObjectData 0x55d4
#define ROM_b08_checkObjectIsCloseToPosition 0x5f86
...
#define ROM_restartSound 0x0cb2
#define ROM_stopTextThread 0x184d
#define ROM_checkReloadStatusBarGraphics 0x1a71
#define ROM_resumeThreadNextFrame 0x08fe
#define ROM_initTextbox 0x4af7
#define ROM_updateTextbox 0x4b1f
#define ROM_b2_fileSelectScreen 0x412e
#define ROM_runSaveAndQuitMenu 0x7380
#define ROM_runIntro 0x4cc9
#define ROM_paletteFadeHandler 0x56e3
#define ROM_checkLockBG7Color3ToBlack 0x591e
#define ROM_runGameLogic 0x596a
...
#define ROM_loadRoomLayout_loadLargeRoomLayoutHlpr 0x3913
#define ROM_loadRoomLayout_decompressLayoutMode2Helper 0x39cf
#define ROM_loadRoomLayout_decompressLayoutMode1Helper 0x39f2
#define paletteHeaderTable_bank01 0x632c
#define roomLayoutGroupTable_bank04 0x4f6c
#define puddleAnimationFrames_bank14 0x405f
#define greenGrassAnimationFrame0_bank14 0x4005
#define data_1058 0x1058
#define wRamFunctionAddr 0xc4b7
