...
substate0:
  ...
  CYC(0x4f1e, 0x4f1f);
  CALL_C(0x4f1f, linkCancelAllItemUsageAndClearAdjacentWallsBitset, 0x4f45, 0x4f22);
...
substate0:
  ...
  CALL_C(0x5001, linkCancelAllItemUsage, 0x4f49, 0x5004);
