...
void linkUpdateMovement_hook(GB *gb) {
  ...
  if (F & FC) {
    CYCT(0x5ad3, 0x5ad5);
    CALL_ROM(0x5ada, 0x5cc3); // animateLinkWalking
  } else {
    CYC(0x5ad3, 0x5ad5);
    CALL_ROM(0x5ad5, 0x5cb5); // animateLinkStanding
    CYC(0x5ad8, 0x5ada);
  }
  ...
  CALL_ROM(0x5ae2, 0x5d97); // specialObjectUpdatePosition
  if (F & FZ) {
    CYCT(0x5ae5, 0x5ae7);
